...
s684++;
else if( (s48 + s1759.s1697).find( ps[s684] ) != string::npos  )
break;
else
return s132;}
s131 s685 = s140;
...
s271* s271::s335( s483* s2124 ) const
...
p = s591::s1119( *tast, s300, obj, s334 );}
else {
...
p = s591::s1119( s701, s300, obj, s334 );
...
pr->s500( s588 );
pr = pr.s15<s371*>()->s377();}
s485 s685 = s271::s1018( s300, pr, s588, NULL, s588->s298() );
return s685;}
const wstring& 
s271::s353() const{
...
s591* 
s483::s1685( s1905& s676, s591* s215,
s561* cs ) const{
if( s676 == L"cp" ) {
return new s1681( s300, (s272*)this, s215, &s483::s1703, cs->s602(),
L"cp",	0, cs->s603() );}
else if( s676 == L"exec" ) {
return new s1681( s300, ns, s215, &s483::s1894, cs->s602(), L"exec",
0, cs->s603() );}
else if( s676 == L"_META_type" ) {
return new s1681( s300, ns, s215, &s483::s1938, cs->s602(), 
...
s685 = ( s685 << 7 ) ^ i;
return s685;}
size_t s491::s1056( const wstring& s, size_t& pos, s813::Cont& s153 ){
size_t s68 = pos;
size_t s685 = 0;
if( s[s68] == L' ' )
...
s685 += L" ";}
return s685;}
wstring s491::s1352( const wstring& tn ){
wstring sv = tn;
...
s1061 s491::s218( s483* p, const std::wstring& s347 ){
...
return s1091;}
void s491::s1666( const std::wstring& s347 ){
...
s1274[s1091] = 0;
s1551[s1091-1].clear();}
s1061 s491::s1068( const s813::Cont& v, const std::wstring& s347 ){
s813 vt( v );
...
if( !composite )
return n;}}
traitnum_t s491::s1252( const std::wstring& trait, s1061& s1510 ){
...
return s1205;}
void s491::s1162( s813::s893 type, const wstring& trait, s1061& s1510 ){
traitnum_t tn;
auto it = s892.find( trait );
if( it == end( s892 ) ) {
...
return true;}
return false;}
void s491::s1171( const wstring& alias, const wstring& s347, 
const wstring& s1840 ){
...
void s491::s1878( const std::wstring& s1112 ){
auto it = s1841.find( s1112 );
if( it != s1841.end() ) {
for( auto it1 = it->second.begin(); it1 != it->second.end(); ++it1 ) {
s1097.erase( *it1 );}}}
wstring s491::s1275( const wstring& tn_ ){
...
s483* s491::s518( s1061 s340, s272* s588, const wstring& s519 ){
if( s340 >= s7::s1554 ) {
...
return s1096[n];}
s1061 s491::s1010( const std::wstring& s347, bool s520 ) const{
auto it = s1097.find( s347 );
if( it == s1097.end() ) {
if( s520 )
...
ptr = new s842( *( s842* )&( *it->second ), s587, std::vector<s271*>(), ct,
it->second.s15<Transd*>()->s603(), s588 );
else if( ct == s591::s566 )
ptr = new s841( *( s841* )&( *it->second ), s588 );
else
ptr = (s591*)it->second->s335( s588 );
t.s541( it->first,  ptr, ap );}
else {
t.s541( it->first, it->second->s335( s588 ), ap );}}}
...
for( ; it != s553.end(); ++it ) {
buf << s4::fill_n_ch( L' ', s197 + s419 ) << it->first << L" :";
if( it->second.s14() ) {
it->second->s304( pd, s197 + s419 * 2 );
buf << endl;}}}
...
void s358::s350(){
s348.insert( make_pair( L"new", new s337( L"new", &s358::s1236, Types.Double,
...
s271* s358::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s360::s1236, Types.Bool,
...
return s355( s588, std::vector<s271*>(), &s701 );}
return NULL;}
s271* s360::s335( s483* s2124 ) const{
...
s271* s361::s335( s483* s2124 ) const{
...
return s365;
return NULL;}
s271* s364::s335( s483* s2124 ) const{
return (s271*)this;}
...
return NULL;}
s271* s384::s335( s483* s2124 ) const{
return (s271*)this;}
inline bool
...
s348.insert( make_pair( L"new", new s337( L"new", &s1706::s1236, s1713,
...
return NULL;}
s271* s1706::s335( s483* s2124 ) const{
...
return s685;}
s1602::s1602( s262* s300, s272* s588, s1905& s77, const s263* ast_ )
: s336( s300, s588, ast_ ){
if( s77.size() ) {
load( s77, false );}
if( !s493 )
...
s685 = it->s352();}
return s685;}
void s1602::load( s1905& s77, bool s1634 ){
...
s1642( obj );}
void s1602::s1642( const s143* obj, s482::s145 ap ){
vector<pair<wstring, s142>> s144;
obj->s160( s144 );
for( size_t n = 0; n < s144.size(); ++n ) {
...
s373( right.s373 ), s374( right.s374 ), 
...
s271* s371::s335( s483* s2124 ) const{
return new s371( *this );}
void s371::s2133( s483* s2124 ){
reset();
s500( (s272*)s2124 );}
...
s348.insert( make_pair( L"new", new s337( L"new", &s346::s1236, s1151,
{ s1122(), s1122( { Types.String } ), s1122( { s1512::s1271 } ) }, 0, 1 ) ) );
...
s271* s346::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s1303::s1236, s1526,
...
s1262();}
s271* s1303::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s1529::s1236, s1527,
{ s1122(), s1122( { s1512::s1271 } ) }, 0, 1 ) ) );
...
s1262();}
s271* s1529::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s1295::s1236, s1308,
{ s1122(), s1122( { s1512::s1271 } ) }, 0, 1 ) ) );
s300->TR().s1162( s493, s7::s1413, s1512::s1271 );
s300->TR().s1162( s493, s7::s1524, s1512::s1549 );}
...
s1262();}
s271* s1295::s335( s483* s2124 ) const{
...
s1262();}
s271* s1573::s335( s483* s2124 ) const{
...
s482 s687;
s272::s272( s262* s300, s1061 s340, s472 pc/* = s473*/, const s263* ast_ )
: s483( s300, pc, ast_, NULL ), s625(NULL), s626(NULL), 
s1663( s7::s1601, s300, s475 ), s347( s471 ), //s633( s687 ),
s629( NULL )//, s1360( ++s1361 )
{
s625 = this;
s493 = s340;}
s272::s272( const s272& proto, std::vector<s485>& s705, const s263* ast_ )
: s483( proto.s300, /*s480*/proto.s492, ast_, proto.ns ), s625( &proto ), s626(NULL), 
s1663( s7::s1601, s300, s475 ), s347( proto.s347 ),
...
s629( NULL )//, s1360( ++s1361 )//, s633( *new s482() )
{
s625 = this;}
...
s628( am ), s629( NULL )//, s1360( ++s1361 ) //,s633( *new s482() )
{
...
s274[n]->s500( s879 );}}
s271* s561::s335( s483* s2124 ) const{
...
return s300->s214( s1451->second, cs->s602(), s588, s215, cs->s603() );
s271* par = NULL;
int s1363 = 0;
s1359:
if( s274.size() ) {
...
if( s1451 != end( s1371 ) )
return s300->s214( s1451->second, s274, s588, s215, cs->s603() );}
else {
wstring s2138 = s601.substr( pl + 1, s601.size() - pl - 2 );
wstring s619 = s300->TR().s1275( s2138 );
s601 = s601.substr( 0, pl );
if( s619 != s2138 ) {
s2138 = s300->TR().s1352( s300->TR().s1275( s2138 ) );
...
s591* ptd = s703.s15<s272*>()->s1685( s601, s215, cs );
if( ptd )
return ptd;
throw new s16( L"Method is not resolved: " + s601 );}}
if( s1237.s339 ) {
s685 = new s841( s300, s215, s566, s274, s1237.s338, s601, cs->s603() );}
else if( s706 ) {
if( s601 == L"new" ) {
assert( 0 );
...
const std::vector<s271*>& l,	const s263* s701, bool s1727=false )
: s272( s300, 0, s476, s701 ), s575( ct ), s576( s572 ),
s586( NULL ),	s588( s592 ), s587( s593 ), past( s701 ), s1654( s300 ),
intro(s1727){
...
const std::vector<s271*>& s705, const s263* s701, bool s2120 )
: s272( right, s2115, s701 ), 
s576( right.s576 ),	s586( NULL ), s588( s592 ), s587( s593 ), 
past( s701 ), s1654( s300 ), intro( s2120 ){
s575 = right.s575;
s582 = right.s582;
s278 = right.s278;
if( s705.size() ) {
...
s274.push_back( right.s274[n]->s335( s593 ) );}}
if( s575 == s567 ) { 
for( size_t n = 0; n < s274.size(); ++n ) {
s485 tmp = s630[n];
...
s584.push_back( right.s584[n]->s335( s593 ) );}
nlocs = right.nlocs;
s498 = right.s498;
...
/*s616 s708,*/ s1061 s709, const wstring& s1553, const s263* s701 )
: s591( s300, s593, s593, ct, L"", s701 ), s1976( false )/*,
s562( s708 )*/
{
s278 = s1553;
s576 = s572;
...
s841::s841( const s841& right, s272* s592 )
: s591( right, s592, (s591*)s592, vector<s484*>(), s603() ), 
s562( right.s562 ), s1976( right.s1976 ){
s278 = right.s278;
s576 = s572;
s493 = right.s493;
s586 = (s483*)right.s586->s335();
...
s272* s592, bool s2120 )
: s591( right, s592 ? s592 : right.s588.s15<s272*>(), 
s593, vector<s484*>(), s701, s2120 ){
...
if( par->s494() == s477 ) {
s490 cs = new s561( *((s561*)par) );
s153 = s600( cs, s300, (s272*)s1672, this, s1672->s298(), false );
s153.s15<Transd*>()->s500( s1672, false );}
...
void s591::s500( const s272* s1672, bool proc/*=false*/ )
{
ns = s588;
s1663.s351( s493 );
s671 = proc ? s588->s298() : s1672->s298();
if( s588 && (s588->s494() == s479 || s588->s494() == s478 )) {
if( 0 && s588->s494() == s478 ) // ???DEBUG??? 220111
return;}
...
if( 0 && s492 == s1245 )
s586 = s300->TR().s518( ((s838*)this)->s1328(), 
(s272*)s1672, s1672->s298() );
else
s586 = s300->TR().s518( s352(), (s272*)s1672, s1672->s298() );}
s586->s500( s587 );
s586->s1679( s7::s867 );
...
throw s968.s1000( L"wrong argument type: for #" + std::to_wstring( n ) + L" parameter expected '" +
s582[n]->s353() + L"', received - '" + par->s353() + L"'" );}
else if( !s300->TR().s1534( par->s352(), s582[n]->s352() ) ) {
throw s968.s1000( L"wrong argument type: for #" + std::to_wstring( n ) + L" parameter expected '" +
s582[n]->s353() + L"', received - '" + par->s353() + L"'" );}
...
s968.s1000( L"wrong argument's type" );}
for( size_t n = 0; n < s630.size(); ++n ) {
if( s630[n]->s618() == s7::s868 )
s968.s1000( L"parameter is not provided" );}}
...
if( s981[n + shift]->s618() == s7::s866 )
s981[n + shift]->s1679( 0 );
else if( s981[n + shift]->s618() != s7::s1747 )
return s981[n + shift];}
...
break;}}
return s685;}
s1357::s1357( s262* s300, s272* s588, s591* s587, const s263* s701 )
...
ref->s382( (s483*)&s1654 );
((s1600*)&s1654)->s1661( s588.s15<s483*>() );}}
else
...
return s630[off];}
s271* s591::s335( s483* s2124 ) const{
return new s591( *this );}
s271* s841::s335( s483* s2124 ) const{
return new s841( *this, s588.s15<s272*>() );}
s271* s842::s335( s483* s2124 ) const{
return new s842( *this );}
s271* s1357::s335( s483* s2124 ) const{
...
s628.s304( pd, s197 + s419 );}
if( !s582.empty() ) {
buf << s4::fill_n_ch( L' ', s197 + s419 ) << L"fpars : ";
for( size_t n = 0; n < s582.size(); ++n ) {
s582[n]->s304( pd, s197 + s419 * 2 );
buf << L"; ";}
buf << endl;}
if( !s274.empty() ) {
buf << s4::fill_n_ch( L' ', s197 + s419 ) << L"pars : ";
for( size_t n = 0; n < s274.size(); ++n ) {
s274[n]->s304( pd, s197 + s419 * 2 );
buf << L"; ";}
buf << endl;}
if( !s631.empty() ) {
buf << s4::fill_n_ch( L' ', s197 + s419 ) << L"namvec : ";
for( size_t n = 0; n < s631.size(); ++n )
buf << s4::fill_n_ch( L' ', s197 + s419 * 2 ) << s631[n].s617()
<< "; ";
buf << endl;}
if( !s630.empty() ) {
buf << s4::fill_n_ch( L' ', s197 + s419 ) << L"memvec : ";
for( size_t n = 0; n < s630.size(); ++n ) {
...
s348.insert( make_pair( L"set", new s337( L"set", &s359::s387, s1152,
...
s1061 s1517 = ( (s316*)Types( s300, Types.Vector ) )->s1195( ts, s1279 );
...
s271* s359::s335( s483* s2124 ) const{
...
s68 = s69 + s72.size();
if( adds->s349.size() )
pv->s320().push_back( adds->s335( NULL ) );}}
...
return s586;}
s271* s817::s335( s483* s2124 ) const{
...
s485 tmp = s271::s1018( s300, s588, (s272*)s879, (s591*)s879, s879->s298() );
s588 = tmp;
s985 = (s326*)s588->s496();}
else {
s985 = (s326*)s271::s1018( s300, s588, (s272*)s879, (s591*)s879, s879->s298() );}
s325 = s985->ValType();
s317 = s985->s319();}
if( s1243.s14() ) {
if( s1243->s494() == s475 )
...
s485 tmp = s271::s1018( s300, s1243, (s272*)s879, (s591*)s879, s879->s298() );
s1243 = tmp;}}
else
s1243 = s365.s15<s484*>();
if( s1244.s14() ) {
if( s1244->s494() == s475 )
s1244.s15<s371*>()->s500( s879 );
else {
s485 tmp = s271::s1018( s300, s1244, (s272*)s879, (s591*)s879, s879->s298() );
s1244 = tmp;}}
else
s1244 = s365.s15<s484*>();}
catch( s16* e ) {
...
s1260( s1168 );}
void s385::s350(){
s348.insert( make_pair( L"new", new s337( L"new", &s385::s1236, s1415,
...
s1470->s500( r->ns );
*s274 = (s483*)s1470;}
s271* s385::s335( s483* s2124 ) const{
...
: s326( s300, NULL, ast_ ), s987( s7::s1374, s300 ), s988(NULL), s349( new s346( s300, 0 )), 
s685( new s346( s300, 0 )),s1353(0){
s493 = Types.Filter;}
s1134::s1134( const s1134& r, const s263* ast_ )
: s326( r.s300, r.ns, ast_ ), s987( s7::s1374, s300 ), s988(NULL), s349( new s346( s300, 0 ) ),
...
: s326( s300, s592, ast_ ), s987( s7::s1374, s300 ), s988(NULL),
...
s985 = (s483*)s271::s1018( s300, s588, (s272*)s879, (s591*)s879, s879->s298() );}
...
where = s271::s1018( s300, where, (s272*)this, (s591*)s879, s879->s298() );}
if( s1070.s14() ) {
if( s1070->s494() == s475 ) {
...
if( s1070->s494() != s1245 )
s1070 = s271::s1018( s300, s1070, (s272*)s879, (s591*)s879, s879->s298() );
...
s1353 = ((s316*)Types( s300, Types.Vector ))->s1195( ts, s1279 );
s1262();}
void s1134::s350(){
s348.insert( make_pair( L"new", new s337( L"new", &s1134::s1236, s1909,
...
s348.insert( make_pair( L"reverse", new s337( L"reverse", NULL, s1152,
{ s1122() }, 0, 0 ) ) );
s348.equal_range( L"new" ).first->second->s1261( true );
...
s274[0]->s1262();}
s271* s1134::s335( s483* s2124 ) const{
...
return;
wstring s998 = L"wrong sequence generator syntax";
s485 tmp = s271::s1018( s300, end, (s272*)s879, (s591*)s879, s879->s298() );
end = tmp;
if( start.s14() ) {
tmp = s271::s1018( s300, start, (s272*)s879, (s591*)s879, s879->s298() );
start = tmp;}
else {
if( end->s352() == s1151 )
...
start->s500( s879 );}}
if( incr.s14() ) {
tmp = s271::s1018( s300, incr, (s272*)s879, (s591*)s879, s879->s298() );
incr = tmp;}
else {
if( start->s352() == s1151 )
...
return s1659;}
void s951::s350(){
s348.insert( make_pair( L"new", new s337( L"new", &s951::s1236, s1416,
...
s271* s951::s335( s483* s2124 ) const{
...
s271* s1143::s335( s483* s2124 ) const{
...
s1172( new s959(NULL, vector<s271*>( { s1173, s365 } )) ){
if( v.s14() ) {
...
s1172( new s959( NULL, vector<s271*>( { s1173, *s1214 } )) ){
s884 = it->s884;}
void s964::reverse(){
s884 = true; 
...
: v( v_ ), s1214( it ), s1086( sent ), s1173( s365 ), s1172( new s959( NULL,
vector<s271*>(	{ s1173, s365 } ) ) ){}
s938::s938( s938* it )
: v( it->v ), s1214( it->s1214 ), s1173( s365 ), s1172( new s959( NULL, 
vector<s271*>(	{ s1173, s365 } ) ) ){}
...
return (*s1214).second.s15<s484*>();}
s271* s938::Idx(){
return (*s1214).first.s15<s484*>();}
s271* s938::El(){
s271* s685 = NULL;
if( s1214 != v->s320().end() ) {
s1172->assign( vector<s485>(
{ ( *s1214 ).first.s15<s484*>(),( *s1214 ).second.s15<s484*>() } ));
s685 = s1214->second;
++s1214;}
return s685;}
void s938::reverse(){
...
: v( v_ ), s1214( it ), s1086( sent ), s1173( s365 ), s1172( new s959( NULL,
vector<s271*>( { s1173, s1214->second } ) ) ){}
...
TDException s968( s7::s1365, s932, ast_ );
s1200 = s1151;
if( s77.size() ) {
load( s77, s588, s1759 );}
if( !s493 )
...
: s1576( right.s300, right.ns, ast_ ){
s349 = right.s349;
s1200 = right.s1200;
s325 = right.s325;
s317 = right.s317;
...
s1061 s316::s1195( s1905& s1273, s813::Cont& s588 ) const{
s1061 s685;
s813::Cont vt;
size_t pos = 0;
s1061 s1277 = 0;
...
if( s1282.size() > 2 )
s1277 = s300->TR().s1046( s1282 );
else
s1277 = s1282[0];
s588 = { s1719, 1, s1277, 0 };
s685 = s300->TR().s1046( s588 );
return s685;}
void s316::s1158( s1905& s1273, s1061& pt, s1061& vt ) const{
s813::Cont s588;
pt = s1195( s1273, s588 );
vt = s588[2];}
void s316::load( const wstring& s77, s272* s588, const s1695& s1759 ){
...
wstring s = s300->TR().s1275( s701.s291() );
wstring sv;
wstring s347 = s353();
wstring s1273, s644;
s1061 pt = 0, vt = 0;
...
if( s1323.find( L"new<Vector<" ) == 0 ) {
wstring stype = s1323.substr( 4, s1323.size() - 5 );
s = stype + L"(" + s + L")";}}
if( s[0] == L'[' && s[s.size() - 1] == L']' ) {
sv = s;}
...
if( s879->s494() != s476 ||
( (s272*)s879 )->s299() != L"new" || s300->s1330() ) {
if( s77[0] == L']' ) {
s349.clear();
wstring snum = s77.substr( s77.rfind( L" " ) );
size_t s163 = std::stoi( snum );
...
s485 s1088 = s271::s1018( s300, s349[n], (s272*)s879, (s591*)s879, s879->s298() );
s349[n] = s1088->s497( 0, 0 ).s15<s484*>();
if( !s325 )
s325 = s349[0]->s352();
...
s959* pd = (s959*)s300->TR().s1007( s325 )->s335();
pd->load( row, s588, s1748 );
s349.push_back( pd );}}}
void s316::s350(){
s1576<s1418, s485, s316>::s350();
s348 = s1576<s1418, s485, s316>::s342();
s348.insert( make_pair( L"new", new s337( L"new", &s316::s1236, s1152,
...
s271* s316::s335( s483* s2124 ) const{
...
s316* s685;
if( s498 == 2 ) {
s685 = (s316*)( s274[1] )->s335();}
else if( s274[2]->s1196().s352() == s1719 ) {
s685 = (s316*)( s274[2] )->s335();}
...
( (s316*)DR )->s349.push_back( (s271*)s1552->s1536( s274[2] ) );}
...
s349[n] = s349[n].s15<s371*>()->s377();}
s485 s1088 = s271::s1018( s300, s349[n], (s272*)s879, NULL, s879->s298() );
s349[n] = s1088;}
s493 = s1718;
s1679( s7::s867 );
s499 = s879->s834();}
...
s271* s750::s335( s483* s2124 ) const{
...
*( (s346*)*s274 )->s357() = (int)( (s959*)DR )->s349.size();}
s271* s959::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s1292::s1236, s1149,
...
s271* s1292::s335( s483* s2124 ) const{
...
pr.first.s15<s1139*>()->s1145(), pr.second.s15<s1139*>()->s1145() );}
s324::s324( s262* s300, s1061 s1201, s1061 s1276, 
...
s813 s1652( s813::Cont( { Types.Index, 1, s317, 0 } ) );
s493 = s300->TR().s1011( s1652 );}
s324::s324( s262* s300, s272* s588, const wstring& s77, const s263* ast_ )
: s1369( s300, s588, ast_ ){
TDException s968( s7::s1368, s932, ast_ );
if( s77.size() ) {
wstring s644, s1273;
vector<pair<wstring, s1::s9<s6::s141>>> s94;
s1160( s77, s1273, s644, s94, ast_ );
if( s94.size() ) {
for( size_t n = 0; n < s94.size(); ++n ) {
s947 s975 = new s263( s94[n].first, s603()->Nqj(), (s263*)s603() );
s483* s1057 = (s483*)s271::s504( *s975, s300, s588, s588->s298() );
basic_stringstream<wchar_t> s1084;
s94[n].second->s155( &s1084 );
s947 s225 = new s263( s1084.str(), s603()->Nqj(), (s263*)s603() );
s483* s1065 = (s483*)s271::s504( *s225, s300, s588, s588->s298() );
if( !s1200 ) {
s1200 = s1057->s352();
s325 = s1065->s352();}
if( s1200 != s1057->s352() || s325 != s1065->s352() )
throw s968.s1000( L"incompatible types in the index initialization list" );
s349.insert( make_pair( s1057, s1065 ) );}}
else if( s644.size() ) {
s813::Cont vt, s1022, s1103;
size_t pos = 0;
s300->TR().s1056( s77, pos, vt );
size_t idx = 2;
s491::s2119( vt, idx, s1022 );
if( s1022.size() > 2 )
s1200 = s300->TR().s1011( s813( s1022 ), false );
else
s1200 = s300->TR().s1011( 
s813( s813::Cont( { s1022[0] } ) ) );
if( !s1200 ) {
if( s1022.size() > 2 )
s1200 = s300->TR().s1046( s1022 );
else
s1200 = s1022[0];}
s491::s2119( vt, idx, s1103 );
if( s1103.size() > 2 )
s325 = s300->TR().s1011( s813( s1103 ), false );
else
s325 = s300->TR().s1011(
s813( s813::Cont( { s1103[0] } ) ) );
if( !s325 ) {
if( s1103.size() > 2 )
s325 = s300->TR().s1046( s1103 );
else
s325 = s1103[0];}}
...
if( sv.size() && regex_match( sv, s1074, rg ) ) {
wstring s1092 = s1074[1].str();
wstring s1093 = s1074[2].str();
sv = L"Index(" + s1092 + L" " + s1093 + L")";
s499 = sv;}}
else
assert( 0 );// s499 = s77;
}
...
if( s1200 ) {
s317 = s300->TR().s1046( s813::Cont( { s1717, 2, s1200, 0, s325, 0 } ) );
s493 = s300->TR().s1046( s813::Cont( { Types.Index, 1, s317, 0 } ) );}
else {
s317 = s493 = 0;}}}
...
void s324::s1160( const wstring& s77, wstring& s1273, wstring& s644,
...
s1161( s300, s77, s1273, s644 );}
void s324::s1158( const std::wstring& s1273, s1061& pt, 
s1061& et, s1061& kt, s1061& vt ) const{
s813::Cont s588;
pt = s1195( s1273, s588, et, kt, vt );}
s483* 
s324::s354( const s263& s701, s272* s588, const std::wstring& s334 ) const{
wstring s = s701.s291();
wstring si;
wstring sv, s1273, s644;
wstring s347 = s353();
s1061 pt = 0, et = 0, kt = 0, vt = 0;
if( s701.s268( s2101 ).s169() == L"CallSite" ) {
wstring s1323 = s701.s268( s2100 ).s169();
if( s1323.find( L"new<Index<" ) == 0 ) {
wstring stype = s1323.substr( 4, s1323.size() - 5 );
s = stype + L"(" + s + L")";}}
if( s[0] == L'{' && s[s.size() - 1] == L'}' )
sv = s; // s4::s52( s, L"{}" );
...
s685->load( sv, s588, L"," );
return s685;}
s1061 s324::s1195( const std::wstring& s1273, s813::Cont& s588,
s1061& et, s1061& kt, s1061& vt ) const{
s1061 s685;
s813::Cont s1279;
size_t pos = 0;
s300->TR().s1056( s1273, pos, s1279 );
s685 = s300->TR().s1011( s813( s1279 ), false );
if( s685 ) {
s588 = { Types.Index, 1, s1279[2], 0 };
et = s1279[2];
const s813& s992 = s300->TR().s1013( et );
kt = s992.s352( 2 );
vt = s992.s352( 4 );
return s685;}
...
s813 s1022( s1468[0] );
kt = s300->TR().s1011( s1022 );
s491::s2119( s1279, idx, s1515 );
if( s1515.size() > 2 )
vt = s300->TR().s1046( s1515 );
else
vt = s1515[0];
et = s300->TR().s1046( 
...
TDException s968( s7::s1597, s932, s603() );
vector<pair<wstring, s1::s9<s6::s141>>> s94;
if( s77[0] == L'{' ) {
s1::s9<s6::s143> ob = new s6::s143( NULL );
size_t pos = 0;
...
s317 = s300->TR().s1046( { s1717, 2, s349.begin()->first->s352(), 0,
s349.begin()->second->s352(), 0 } );
s813::Cont v1 = { Types.Index, 1, s317, 0 };
s493 = s300->TR().s1046( v1 );}
else if( s325 != s349.begin()->second->s352() )
throw s968.s1000( L"index' element type doesn't match the index type" );}}
void s324::s500( const s272* s879, bool ){
TDException s968( s7::s923, s932, s603(), L"wrong Index definition" );
...
s491::s2119( vt, idx, s1022 );
s813 s1021( s1022[0] );
s1200 = s300->TR().s1011( s1021 );
s491::s2119( vt, idx, s1103 );
s813 s1100( s1103[0] );
s325 = s300->TR().s1011( s1100 );}
else if( s77[0] == L'{' ) {
assert( 0 );
vector<s1::s9<s6::s141>> s153;
s1::s9<s6::s143> ob = new s6::s143( NULL );
...
ob->s160( s144 );
for( size_t n = 0; n < s144.size(); ++n ) {
s947 s975 = new s263( s144[n].first, s603()->Nqj(), (s263*)s603() );
s483* s1057 = (s483*)s271::s504( *s975, s300, (s272*)s879, s879->s298() );
basic_stringstream<wchar_t> s1084;
s144[n].second->s155( &s1084 );
s947 s225 = new s263( s1084.str(), s603()->Nqj(), (s263*)s603() );
s483* s1065 = (s483*)s271::s504( *s225, s300, (s272*)s879, s879->s298() );
if( !s1200 ) {
s1200 = s1057->s352();
s325 = s1065->s352();}
if( s1200 != s1057->s352() || s325 != s1065->s352() )
...
s348.insert( make_pair( L"new", new s337( L"new", &s324::s1236, s1152,
{ s1122(), s1122( { s7::s1393, s7::s1399 } ) }, 0, 0, false, { L":typedTable", L":untypedTable" } ) ) );
...
s324* s685 = new s324( s300, s1201, s1276, s588, NULL );
return s685;}
...
s271* s324::s335( s483* s2124 ) const{
...
s324* s685 = NULL;
if( s498 == 2 ) {
s685 = (s324*)( s274[1] )->s335();}
else if( s274[2]->s1196().s352() == s1715 ) {
s685 = (s324*)( s274[2] )->s335();}
else {
assert( 0 );
vector<s271*> v;
...
if( it == dr->s349.end() ) {
s486 s1241 = (s483*)s349->s335();
s486 s1594 = (s483*)s152->s335();
...
s325 = s1276;
s813 s1182( s813::Cont( { s1717, 2, s1200, 0, s325, 0 } ) );
s493 = s300->TR().s1011( s1182 );}
s1382::s1382( s262* s300, s272* s588, const wstring& s77, const s263* ast_ )
: s1369( s300, s588, ast_ ){
TDException s968( s7::s1667, s932, ast_ );
if( s77.size() ) {
wstring s644, s1273;
vector<pair<wstring, s1::s9<s6::s141>>> s94;
s1160( s77, s1273, s644, s94, ast_ );
...
if( s1200 ) {
s317 = s300->TR().s1046( s813::Cont( { s1717, 2, s1200, 0, s325, 0 } ) );
s493 = s300->TR().s1046( s813::Cont( { Types.HashIndex, 1, s317, 0 } ) );}
else {
s317 = s493 = 0;}}}
...
return 0;
return new s1382( s300, s588, si, &s701 );}
...
s1::s9<s1382> s685 = new s1382( s300, s588, L"", ast_ );
s685->s1200 = s1200;
s685->s325 = s325;
return s685;}
...
s813 s1100( s1103[0] );
s1061 s1276 = s300->TR().s1011( s1100 );
s1382* s685 = new s1382( s300, s1201, s1276, NULL );
return s685;}
...
return ( s502->s352() == s352() );}
s271* s1382::s335( s483* s2124 ) const{
...
s1386::iterator it = dr->s349.find( (s483*)PARN( 2 ) );
if( it == dr->s349.end() ) {
s483* s1241 = (s483*)s349->s335();
dr->s349.insert( make_pair( (s483*)s152->s335(), s1241 ) );
*s274 = s369;}
else {
it->second = (s483*)s349->s335();
*s274 = s370;}}
...
Types( s300, Types.String )->s353() + L">";
s1061 s1517 = ((s316*)Types( s300, Types.Vector ))->s1195( ts, s1279 );
s348.insert( make_pair( L"new", new s337( L"new", &s415::s1236, s1907,
{ s1122() }, 0, 0 ) ) );
...
s271* s415::s335( s483* s2124 ) const{
...
pv->add( po );}
return s586;}
s271* s1605::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s507::s1236, s1152,
{ s1122() }, 0, 0 ) ) );
...
return NULL;}
s271* s507::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s1294::s1236, s1152,
{ s1122() }, 0, 0 ) ) );
...
return NULL;}
s271* s1294::s335( s483* s2124 ) const{
...
s348.insert( make_pair( L"new", new s337( L"new", &s1302::s1236, s1152,
{ s1122() }, 0, 0 ) ) );
...
wstring ts = Types( s300, Types.Vector )->s353() + L"<" + 
Types( s300, Types.String )->s353() + L">";
s1061 pt = ((s316*)Types( s300, Types.Vector ))->s1195( ts, s1279 );
...
return NULL;}
s271* s1402::s335( s483* s2124 ) const{
...
return NULL;}
s271* s1404::s335( s483* s2124 ) const{
...
s631.push_back( *s76 );}
s584.insert( s584.end(), l.begin() + n, l.end() );}
s605::s605( const s605& right, s272* s2124 )
: s591( right, s2124, (s591*)s2124, vector<s484*>(), s603(), true ){
s493 = 0;// Types.Null;
}
void
...
break;}}}
return s685;}
s271* s605::s335( s483* s2124 ) const{
s605* s685 = new s605( *this, (s272*)s2124 );
s685->s2133( s685 );
return s685;}
s271* s305::s335( s483* s2124 ) const{
return new s305( *this );}
s271* s307::s335( s483* s2124 ) const{
return new s307( *this );}
s271* s614::s335( s483* s2124 ) const{
...
s838::s838( s262* s300 )
: s591( s300, NULL, NULL, s567, s252, NULL, true ), s2104( false ){
s492 = s1245;
s493 = Types.Lambda;
if( !s493 )
wh = s7::s868;
...
: s591( s300, s592, NULL, s567, s252, s701, true ), s2104( false ){
s492 = s1245;
s493 = pt;
...
: s591( s1901, s592, s593, vector<s484*>(), s701, true ), s2104( s1901.s2104 ),
s2110( s1901.s2110 ){
s492 = s1245;
s493 = s1901.s493;
s1903 = s1901.s1903;
...
s483* s2109 = ref->s377();
s631.push_back( *ref );
s630.push_back( s2109->s335( this ) );
...
wstring s = s300->TR().s1352( s300->TR().s1275( s701.s291() ));
wstring sv;
...
s490 cs = s591::s1119( *ast_, s300, s588, s588->s298() );
...
if( s215 )
s586 = s300->TR().s518( s1328(), (s272*)s215, s215->s298() );
else
...
s591* s838::s1685( const std::wstring& s676, s591* s215, 
s561* cs ) const{
if( s676 == L"new" ) {
...
s1922, L"new", 0, cs->s603() );}
return s483::s1685( s676, 
/*(s591*)this*/s215, cs ); // ???DEBUG??? 220113
}
s271* s838::s335( s483* s2124 ) const{
s838* s685 = new s838( *(s838*)this, (s272*)s2124, 
(s591*)this, vector<s485>(), NULL );
return s685;}
void s838::s2133( s483* s2124 ){
s591::s2133( s2124 );
if( s2110.s14() ) {
const vector<s485>& v = s2110->s320();
for( size_t n = 0; n < v.size(); ++n ) {			
...
ref->s2133( s2124 );
s483* s2109 = ref->s377();
s271* s2135 = s2109->s335( s2124 );
if( !s2135->s1204() )
s2135->s500( (s272*)s2124, false );
...
return s586;}}
return s586;}
s1407::s1407( s262* s300, s272* s592, s591* s593, const std::vector<s271*>& l, const s263* s701 )
: s591( s300, s592, s593, s565, s1428, s701, true ),s1502( s7::s1374, s300 ),
s311( s7::s462, s300 ), s312( s300, 0 ){
...
lambda = s271::s1018( s300, lambda, this, this, s587->s298() );}}
...
: s591( s300, s592, s593, s565, s1944, s701, true ){
...
s608::s608( const s608& right, s272* s2124 )
: s591( right, s2124, (s591*)s2124, vector<s484*>(), right.s603() ){
for( size_t n = 0; n < right.s620.size(); ++n )
s620.push_back( right.s620[n]->s335( s2124 ) );
for( size_t n = 0; n < right.s621.size(); ++n ) {
s621.push_back( s579() );
for( size_t m = 0; m < right.s621[n].size(); ++m )
s621.back().push_back( right.s621[n][m]->s335( s2124 ) );}
s493 = 0;// Types.Null;
}
...
: s591( s300, s592, s593, /*s565*/ s2113, s852, s701 )
{
if( l.size() > 1 )
...
s493 = 0;}
s839::s839( const s839& right, s272* s2124 )
: s591( right, s2124, (s591*)s2124, vector<s484*>(), s603() ){}
void
s839::s500( const s272* s1672, bool proc ){
if( s274.size() ) {
if( !s493 )
s493 = s1152;
s591::s500( s1672, false );
...
s493 = p->s352();
s586 = s300->TR().s518( s493, (s272*)s1672, s1672->s298() );}
else {
s586 = s583[1]->s496();
s493 = s586->s352();}}
else {
...
s685->s1679( s7::s866 );
return s685;}
s271* s839::s335( s483* s2124 ) const{
s839* s685 = new s839( *this, (s272*)s2124 );
return s685;}
s896::s896( s262* s300, s272* s592, s591* s593, const std::vector<s271*>& l, const s263* s701 )
: s591( s300, s592, s593, s565, s900, s701 ), code( 0 ){
if( l.size() > 1 )
...
s271* s896::s335( s483* s2124 ) const{
...
: s591( s300, s592, s593, s565, L"", s701 ), s1684( ptr_ ){
subject = cs->s602()[0];
...
const s263* s701 )
: s591( s300, s592, s593, s565, s676, s701 ), s1684( ptr_ ){
subject = s1922[0];
s274.assign( s1922.begin() + 1, s1922.end() );
s493 = s1072;
ns = s588;}
s1681::s1681( const s1681& right, s272* s2124 )
: s591( right, s2124, (s591*)s2124, vector<s484*>(), s603() ),
...
return (s483*)s703->s335();}
else if( s278 == L"exec" ) {
if( s703->s618() < 0 )
s703->s500( s587, false );
s9<s838> pf = (s838*)s703->s335( s587 );
vector<s485> s2127;
for( auto par_ : s274 ) {
s483* par = NULL;
if( par_->s494() == s475 )
...
return s586;}
s1604::s1604( s262* s300, s272* s592, s591* s593, const std::vector<s271*>& l, const s263* s701 )
: s591( s300, s592, s593, s565, s1615, s701 ){
if( l.size() != 2 )
throw new s16( s1615 + L"(): wrong numbers of arguments" );
s274.assign( l.begin(), l.end() );}
s1604::s1604( const s1604& right )
: s591( right ){}
void
...
: s591( s300, s592, s593, s565, s1614, s701 ){
if( l.size() != 1 )
throw new s16( s1614 + L"(): wrong numbers of arguments" );
s274.assign( l.begin(), l.end() );}
s1603::s1603( const s1603& right, s272* s2124 )
: s591( right, s2124, (s591*)s2124, vector<s484*>(), right.s603() ){
...
: s591( s300, s592, s593, s565, s1886, s701 ){
if( l.size() > 2 )
...
return s586;}
s271* s608::s335( s483* s2124 ) const{
s608* s685 = new s608( *this, (s272*)s2124 );
s685->s2133( s2124 );
return s685;}
s271* s606::s335( s483* s2124 ) const{
return new s606( *this );}
s271* s607::s335( s483* s2124 ) const{
return new s607( *this );}
s271* s1407::s335( s483* s2124 ) const{
return new s1407( *this );}
s271* s2077::s335( s483* s2124 ) const{
return new s2077( *this );}
s271* s1939::s335( s483* s2124 ) const{
return new s1939( *this );}
s271* s611::s335( s483* s2124 ) const{
return new s611( *this );}
s271* s612::s335( s483* s2124 ) const{
return new s612( *this );}
s271* s613::s335( s483* s2124 ) const{
return new s613( *this );}
s271* s755::s335( s483* s2124 ) const{
return new s755( *this );}
s271* s1680::s335( s483* s2124 ) const{
return new s1680( *this );}
s271* s1681::s335( s483* s2124 ) const{
s1681* s685 = new s1681( *this, (s272*)s2124 );
return s685;}
s271* s1609::s335( s483* s2124 ) const{
return new s1609( *this );}
s271* s1607::s335( s483* s2124 ) const{
return new s1607( *this );}
s271* s1604::s335( s483* s2124 ) const{
return new s1604( *this );}
s271* s1608::s335( s483* s2124 ) const{
return new s1608( *this );}
s271* s1603::s335( s483* s2124 ) const{
return new s1603( *this, (s272*)s2124 );}
s271* s1885::s335( s483* s2124 ) const{
...
lout( false ){
s493 = Types.Null;}
s609::s609( const s609& right, s272* s2124 )
: s591( right, s2124, 
(s591*)s2124, vector<s484*>(), s603() ), s42( right.s42 ),
lout( right.lout ){
s493 = Types.Null;}
...
s778->s1481( L"" );
return s365;}
s271* s609::s335( s483* s2124 ) const{
s609* s685 = new s609( *this, (s272*)s2124 );
return s685;}
...
: s591( s300, s592, s593, s565, s1945, s701 ), source( NULL ),
lin( false ){
if( l.empty() )
throw new s16( L"Wrong numbers of arguments" );
...
: s591( s300, NULL, NULL, s565, s1945, NULL ), source( NULL ),
lin( false ){
s493 = Types.Null;}
...
src->ws();
return s365;}
s271* s1940::s335( s483* s2124 ) const{
...
s490 cs = s591::s1119( *ast_, s300, s588, s298() );
s912.push_back( cs );
...
return s685;}
s271* s610::s335( s483* s2124 ) const{
...
s586 = s906->run( s911 );
return s586;}
s271* s615::s335( s483* s2124 ) const{
...
s300->s209( s194 );
return s365;}
s271* s797::s335( s483* s2124 ) const{
...
return s365;}
s271* s1307::s335( s483* s2124 ) const{
...
wcout << L"An exception was raised: \n\n" << U16( e.what() ) << endl;}
return s365;}
s271* s1610::s335( s483* s2124 ) const{
...
ptr->clear();
delete ptr;}}
const vector<wstring> s1778::s1879 = { L"", L"==", L"<", L">", L"<=", L">=" };
...
s69 = s68 = s.find_first_not_of( s4::s48, s69 );
s4::s1001( s, s69, s4::s48 + L")" );
wstring s1866 = s.substr( s68, s69 - s68 );
s947 s701 = new s263( L"", s1866 );
...
: s591( s300, s592, s593, s565, s818, s701 ), s2038( s7::s1982, s300 ),
...
return NULL;}
void s791::s2063( s1781* base, s485 what, std::vector<std::wstring>& s895,
...
s2063( base, sqp->what, s895, s2061 );
s1::s1289<s1782> dom = base->s1818();
if( s1859 ) {
s1859->select( base, dom );}
else
...
for( size_t n = 0; n < s895.size(); ++n )
s894->add( s1857->s760( s895[n] ).s15<s484*>() );}
s894->s1679( s7::s867 );
...
s2032.resize( s1868.size() );
s835 s2058;
if( sqp->s2057.s14() ) {
sqp->s2057.s15<s838*>()->s814( s2058 );
for( auto p: s2058 )
s2033.push_back( p.second->s335() );
...
if( sqp->s1867.s14() ) {
for( size_t n = 0; n < s1868.size(); ++n )
s2032[n] = s1857->s760( s1868[n] ).s15<s484*>();
...
s271* s791::s335( s483* s2124 ) const{
...
s1262();}
void s650::s350(){
s348.insert( make_pair( L"new", new s337( L"new", &s650::s1236, s1798,
{ s1122() }, 0, 0 ) ) );
...
s271* s650::s335( s483* s2124 ) const{
...
s1262();}
void s1801::s350(){
s348.insert( make_pair( L"new", new s337( L"new", &s1801::s1236, s1797,
{ s1122() }, 0, 0 ) ) );
...
s271* s1801::s335( s483* s2124 ) const{
...
void s2062::s350(){
assert(0);}
s271* s2062::s335( s483* s2124 ) const{
...
s7::s1995 };}
s1999 s1987::s2003( const wstring& s2039 ){
...
void s262::s209( const wstring& s661, bool s1902 ){
s722 s646;
s263* s208 = new s263();
...
s208.s289( obj );
s207( s208 );}
void s262::s1650( const std::wstring& s671 ){
...
s1061 pt = ((s316*)Types( this, Types.Vector ))->s1195( ts, s1279 );
...
vector<s485> s274;
for( size_t n = 0; n < l.size(); n++ ) {
s947 ast_ = new s263( l[n], NULL );
s490 cs = s591::s1119( *ast_, this, mod, mod->s298() );
s274.push_back( cs );}
s673->s596( s274 );
s484* pr = s673->s496();
try {
...
s1061 s262::s218( s483* p, const wstring& s347 ){
...
s685 = new s1604( this, s588, s215, s705, s701 );
else if( s1457 == s1443 ) {
...
s685 = new s1603( this, s588, s215, s705, s701 );
else if( s1457 == s1887 )
...
void * pv = s685->addr();
return pv;}
void s262::s1351( const wstring& s671 ){
s203.s1878( s671 );
s628.s542( s671 );
if( s203.s156( s671) )
s203.s1666( s671 );}
void s262::s1665( const wstring& s1633 ){
