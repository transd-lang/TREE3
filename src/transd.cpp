...
else if ( s190.find( s79[pos] ) != string::npos ) {
s203 = s187( s79, pos, s167 );
}
else {
if( s188( s79, pos, b ) )
s203 = s141;
...
s1016 s1244							= 710;
s1016 s1245					= 711;
s1016 CLTDMaxElement_ctor1		= 804;
s1016 CLFilterVal_ctor1				= 904;
s1016 CLIndexVal_ctor1				= 1004;
s1016 s1246					= 1124;
set<wstring> s1241 = { s7::s1242 };
} // namespace s7
...
const wstring s267 = L"new";
const wstring s1304 = L"max-element";
...
s278* s278::s525( const s270& s737, s269* s307, s279* obj,
const wstring& s347 )
{
s278* p;
if( s737.s304() == s231 ) {
...
s278* 
s278::s1122( s269* s307, s278* par, s279* s613, s616* s220,
...
s504
s278::s1121( const wstring& s79, const s270* ast_, s269* s307, s279* s613 )
{
...
bool s502::s1342( s1172 s647, traitnum_t tra ) {
double d = (double)s307->TR().s1295( s647 ) / tra;
return ( d == (int)d );
}
s502* s502::s371( s279* s613, const std::vector<s1172>& vt ) const
{
assert(0);
return 0;
}
s1172 s502::s1332( const wstring& methName, const vector<s504>& l ) const
{
...
traitnum_t s510::s1404( const std::wstring& trait )
{
s1351 = s1337( s1351 );
s979[trait] = s1351;
s1411[s1351] = trait;
...
void s510::s1302( s869::s980 type, const std::wstring& trait )
{
...
traitnum_t tn = it->second;
s1429[type] *= tn;
}
void s510::s1064( s869::s980 type, const std::wstring& cat, const std::wstring& s1073 )
{
auto s1213 = s1005.find( type );
if( s1213 == s1005.end() )
s1213 = s1005.insert( make_pair( type, s1001() ) ).first;
auto s1078 = s1213->second.find( cat );
if( s1078 == s1213->second.end() )
s1078 = s1213->second.insert( make_pair( cat, set<wstring>() ) ).first;
s1078->second.insert( s1073 );
}
bool s510::s1117( s869::s980 type, const std::wstring& cat, 
const std::wstring& s1073 )
{
vector<s869::s980> types = { type };
if( s1219[type].s367() != type )
types.push_back( s1219[type].s367() );
for( auto t : types ) {
auto s1213 = s1005.find( t );
if( s1213 != s1005.end() ) {
auto s1078 = s1213->second.find( cat );
if( s1078 != s1213->second.end() )
if( s1078->second.find( s1073 ) != s1078->second.end() )
return true;
}
}
return false;
}
void s510::s1106( s869::s980 type, const std::wstring& cat, 
vector<wstring>& s157 )
{
auto s1213 = s1005.find( type );
if( s1213 == s1005.end() )
throw new s17( L"type is not found" );
auto s1078 = s1213->second.find( cat );
if( s1078 == s1213->second.end() )
throw new s17( L"class attribute category is not found: " + cat );
s157.assign( s1078->second.begin(), s1078->second.end() );
}
wstring s510::s1106( s869::s980 type, const std::wstring& cat )
{
auto s1213 = s1005.find( type );
if( s1213 == s1005.end() )
throw new s17( L"type is not found" );
...
if( s1078 == s1213->second.end() )
throw new s17( L"class attribute category is not found: " + cat );
if( s1078->second.size() != 0 )
throw new s17( L"class attribute category is not single valued: " + cat );
return *s1078->second.begin();
}
...
wstring s510::s1430( const s270& s737 )
{
wstring s = s737.s298().substr(0, s737.s298().find_first_of( L" (" ));
auto it = s1215.find( s );
if( it == end( s1215 ) )
return s737.s298();
const wstring& tn = s1214[s1220[s1219[it->second]]];
if( tn != s ) {
wstring s718 = s737.s298();
return s718.replace( 0, s.size(), tn );
}
return s737.s298();
}
s502* s510::s542( const s270& s737, s279* s613, const wstring& s543 )
{
wstring s364 = s737.s298();
...
s502* s510::s542( s1172 s355, s279* s613, const wstring& s543 )
{
...
s1172 s510::s1111( const std::wstring& s362 ) const
{
auto it = s1215.find( s362 );
if( it == s1215.end() )
...
s1172 s510::s1112( const s869& vt ) const
{
auto it = s1220.find( vt );
if( it == end( s1220 ) )
...
{
if( t >= s1231.size() )
throw new s17( L"no prototype for the type with id " + to_wstring( t ) );
return s1231[t].s16<const s502*>();
}
bool s510::s1124( s869::s980 type )
{
return ( s1117( type, s7::s1003, L"container" ) ||
s1117( type, s7::s1003, L"ordered" ) ||
s1117( type, s7::s1003, L"indexed" )		);
auto s1213 = s1005.find( type );
if( s1213 != s1005.end() ) {
auto s1078 = s1213->second.find( s7::s1003 );
if( s1078 != s1213->second.end() )
return (s1078->second.find( L"container" ) != s1078->second.end() ||
s1078->second.find( L"ordered" ) != s1078->second.end() ||
s1078->second.find( L"indexed" ) != s1078->second.end()
);
}
return false;
}
bool s510::s1350( s869::s980 type )
{
return ( s1117( type, s7::s1003, L"ordered" ) );
}
void s510::s841()
{
...
void s501::s520( s279* s962, bool s539/*= true*/ )
{
for( auto sym : s577 ) {
...
s351::s356 s528::s363;
size_t s351::s804 = 0;
traitnum_t s351::s1426 = 0;
traitnum_t s351::s1424 = 0;
traitnum_t s351::s1423 = 0;
traitnum_t s351::s1425 = 0;
s9<s400> s829;
s9<s380> s781;
s9<s377> s876;
s9<s376> s803;
...
s1426 = s307->TR().s1404( L":Number" );
s1424 = s307->TR().s1404( L":ContainerForward" );
s1423 = s307->TR().s1404( L":ContainerBidirectional" );
s1425 = s307->TR().s1404( L":ContainerIndexed" );
if( !soft ) {
s804 = s843->s367();
s381 = new s380( s307 );
...
s1172 pt2_ = s548.s1000[n]->s1340().s367(2);
...
if( s548.s613 && s548.s613->s1342( s1316, s351::s1291() ) )
s1422 = true;
}
else if( s1320 == s1277 ) {
if( s548.s613 && s548.s613->s1342( s1316, s351::s1290() ) )
s1422 = true;
}
else if( s1320 == s1281 ) {
if( s548.s613 && s548.s613->s1342( s1316, s351::s1292() ) )
s1422 = true;
}
else if( s1320 == s1279 ) {
if( s548.s613 && s1316 == ((s337*)s548.s613)->s328() )
...
if( s548.s613 && s1316 == ((s337*)s548.s613)->ValType() )
s1422 = true;
}
...
if( s548.s613 ) {
if( s548.s613->s1342( s1321, s351::s1291() ) )
continue;
else
return true;
}
...
if( s548.s613 ) {
if( s548.s613->s1342( s1321, s351::s1290() ) )
continue;
else
return true;
}
...
if( s548.s613 ) {
if( s548.s613->s1342( s1321, s351::s1292() ) )
continue;
else
return true;
}
...
if( s613 ) {
if( s613->s1342( s1318, s351::s1291() ) )
continue;
else
return true;
}
...
if( s613 ) {
if( s613->s1342( s1318, s351::s1290() ) )
continue;
else
return true;
}
...
if( s613 ) {
if( s613->s1342( s1318, s351::s1292() ) )
continue;
else
return true;
}
...
s364.find( L"Int(" ) == 0 ) {
return s825->s370( s270(s364, NULL), NULL, s347 );
}
else 
return s859->s370( s270(s364, NULL), NULL, s347 );
}
s361::s361( s269* s307, int i )
: s351( s307, NULL ), s364( i )
{
if( s825.s13() ) {
s513 = 0;
wh = s7::s943;
...
void s361::s365()
{
s363.insert( make_pair(L"abs", new s352( L"abs", &s361::s420, s1285,
{ s1240( { } ) }, 0, 0 )));
s363.insert( make_pair( L"set", new s352( L"set", &s361::s403, s1287,
{ s1240( { s1285 } ) }, 1, 1, false )));
s363.insert( make_pair( L"sum", new s352( L"sum", &s361::s404, s1285,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"dif", new s352( L"dif", &s361::s405, s1285,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"mul", new s352( L"mul", &s361::s406, s1285,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"div", new s352( L"div", &s361::s407, s1285,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"pow", new s352( L"pow", &s361::s408, s1285,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"pow", new s352( L"pow", &s361::s408, s1284,
{ s1240( { s1284 } ) }, 1, 1 )));
s363.insert( make_pair( L"sumeq", new s352( L"sumeq", &s361::s409, s1285,
{ s1240( { s1285 } ) }, 1, 1, false )));
s363.insert( make_pair( L"difeq", new s352( L"difeq", &s361::s410, s1285,
{ s1240( { s1285 } ) }, 1, 1, false )));
s363.insert( make_pair( L"muleq", new s352( L"muleq", &s361::s411, s1285,
{ s1240( { s1285 } ) }, 1, 1, false )));
s363.insert( make_pair( L"diveq", new s352( L"diveq", &s361::s412, s1285,
{ s1240( { s1285 } ) }, 1, 1, false )));
s363.insert( make_pair( L"poweq", new s352( L"poweq", &s361::s413, s1285,
{ s1240( { s1285 } ) }, 1, 1, false )));
s363.insert( make_pair( L"eq", new s352( L"eq", &s361::s414, s1276,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"less", new s352( L"less", &s361::s415, s1276,
{ s1240( { s1285, s1285 } ) }, 2, 2 )));
s363.insert( make_pair( L"greater", new s352( L"greater", &s361::s416, s1276,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"leq", new s352( L"leq", &s361::s417, s1276,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"geq", new s352( L"geq", &s361::s418, s1276,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"neq", new s352( L"neq", &s361::s419, s1276,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"mod", new s352( L"mod", &s361::s421, s1285,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"sqrt", new s352( L"sqrt", &s361::s422, s1284,
{ s1240( { } ) }, 0, 0 )));
s363.insert( make_pair( L"nroot", new s352( L"nroot", &s361::s423, s1284,
{ s1240( { s1285 } ) }, 1, 1 )));
s363.insert( make_pair( L"toDouble", new s352( L"toDouble", &s361::s424, s1284,
{ s1240( { } ) }, 0, 0 )));
s363.insert( make_pair( L"read", new s352( L"read", &s361::s425, s1285,
{ s1240( { } ) }, 0, 0, false )));
}
s502* s361::s371( s279* s613, const std::vector<s278*>& l ) const
{
size_t pos = 0;
return new s361( s307, L"", pos );
}
void s361::s520( s279* s962 )
{
}
...
inline void s361::s420( s502** s281, size_t s518 )
{
int t = (int)*DR;
if( t >= 0 )
s734->s364 = t;
...
inline void s361::s403( s502** s281, size_t s518 )
{
( (s361*)DR)->s364 = (int)*PARN(2);
}
inline void s361::s404( s502** s281, size_t s518 )
{
s734->s364 = ( (int)*DR ) + (int)*PARN( 2 );
for( size_t n = 3; n < s518; ++n )
s734->s364 += (int)*PARN( n );
}
inline void s361::s405( s502** s281, size_t s518 )
{
s734->s364 = ( (int)*DR ) - (int)*PARN( 2 );
for( size_t n = 3; n < s518; ++n )
s734->s364 -= (int)*PARN( n );
}
inline void s361::s406( s502** s281, size_t s518 )
{
s734->s364 = ((int)*DR) * (int)*PARN(2);
for( size_t n = 3; n < s518; ++n )
s734->s364 *= (int)*PARN( n );
}
inline void s361::s407( s502** s281, size_t s518 )
{
s734->s364 = ( (int)*DR ) / (int)*PARN( 2 );
for( size_t n = 3; n < s518; ++n )
s734->s364 /= (int)*PARN( n );
}
inline void s361::s408( s502** s281, size_t s518 )
{
s734->s364 = (int)::pow( (int)*DR, (double)*PARN( 2 ) );
}
inline void s361::s409( s502** s281, size_t s518 )
{
( (s361*)DR )->s364 += (int)*PARN(2);
for( size_t n = 3; n < s518; ++n )
( (s361*)DR )->s364 += (int)*PARN(n);
s734->s364 = ( (int)*DR );
}
inline void s361::s410( s502** s281, size_t s518 )
{
( (s361*)DR )->s364 -= (int)*PARN(2);
for( size_t n = 3; n < s518; ++n )
s734->s364 -= (int)*PARN( n );
...
inline void s361::s411( s502** s281, size_t s518 )
{
s734->s364 = ((int)*DR) * (int)*PARN(2);
for( size_t n = 3; n < s518; ++n )
s734->s364 *= (int)*PARN( n );
}
inline void s361::s412( s502** s281, size_t s518 )
{
s734->s364 = ( (int)*DR ) / (int)*PARN( 2 );
for( size_t n = 3; n < s518; ++n )
s734->s364 /= (int)*PARN( n );
}
inline void s361::s413( s502** s281, size_t s518 )
{
s734->s364 = ( (int)*DR ) * ( (int)*DR ); ;
for( int n = 2; n < (int)*PARN( 2 ); ++n )
s734->s364 *= ( (int)*DR );
}
inline void s361::s414( s502** s281, size_t s518 )
{
...
inline void s361::s415( s502** s281, size_t s518 )
{
if( ( (int)*DR ) < (int)*PARN( 2 ) )
*s735->s373() = 1;
else
...
inline void s361::s416( s502** s281, size_t s518 )
{
if( ( (int)*DR ) > (int)*PARN( 2 ) )
*s735->s373() = 1;
else
...
inline void s361::s417( s502** s281, size_t s518 )
{
if( ( (int)*DR) <= (int)*PARN( 2 ) )
*s735->s373() = 1;
else
...
inline void s361::s418( s502** s281, size_t s518 )
{
if( ( (int)*DR ) >= (int)*PARN( 2 ) )
*s735->s373() = 1;
else
...
inline void s361::s419( s502** s281, size_t s518 )
{
if( ( (int)*DR ) != (int)*PARN( 2 ) )
*s735->s373() = 1;
else
...
inline void s361::s421( s502** s281, size_t s518 )
{
s734->s364 = ( (int)*DR ) % (int)*PARN( 2 );
}
inline void s361::s422( s502** s281, size_t s518 )
{
*((s374*)s281[0])->s373() = ::sqrt( (double)*DR );
}
inline void s361::s423( s502** s281, size_t s518 )
{
*((s374*)s281[0])->s373() = ::pow( (int)*DR, 1.0/(double)*PARN( 2 ) );
}
inline void s361::s424( s502** s281, size_t s518 )
{
*( (s374*)s281[0] )->s373() = (double)*DR;
}
inline void s361::s425( s502** s281, size_t s518 )
{
int i;
...
s502* s361::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
if( s.find_first_not_of( L"-0123456789" ) == std::string::npos ) {
size_t pos = 0;
return new s361( s307, s, pos );
}
else if( s.find( L"Int(" ) == 0 ) {
size_t pos = 0;
return new s361( s307, s.substr( 4, s.size() - 5 ), pos );
}
else if( s.find( L"Int" ) == 0 ) {
return s371( NULL, std::vector<s278*>() );
}
return 0;
}
size_t s361::s331() const
{
return (size_t)s364;
}
inline bool s361::operator==( const s502* p ) const
{
return ( (s361*)p )->s364 == s364;
}
inline bool s361::operator<( const s502* p ) const
{
return s364 < ( (s361*)p )->s364;
}
s502* s374::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
if( s.find_first_not_of( L"-0123456789." ) == std::string::npos &&
...
return s371( s613, std::vector<s278*>() );
}
return 0;
}
...
s502* s374::s371( s279* s613, const std::vector<s278*>& l ) const
{
size_t pos = 0;
return new s374( s307, L"", pos );
}
void s374::s520( s279* s962 )
{
}
void s374::s365()
{
...
{ s1240( { s1284, s1284 } ) }, 2, 2 )));
s363.insert( make_pair( L"toInt", new s352( L"toInt", &s374::s428, s1285,
{ s1240( { } ) }, 0, 0 )));
}
...
: s351( right.s307, NULL ), s364( right.s364 )
{
s513 = s803->s367();
}
s376::s376( s269* s307, bool b )
: s351( s307, NULL ), s364( b )
{
if( s803.s13() ) {
s513 = 0;
setWh( s7::s943 );
...
void s376::s520( s279* s962 )
{
}
s502* s376::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s376( s307, false );
}
s502* s376::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
...
{
std::wostream& buf = *pd;
buf << s4::fill_n_ch( L' ', s202 ) << s369() << L" : " << to_wstring() << endl;
}
...
void s377::s520( s279* s962 )
{
}
s502* s377::s371( s279* s613, const std::vector<s278*>& l ) const
{
...
s502* s377::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
...
void s380::s520( s279* s962 )
{
}
s502* s380::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s380( s307 );
}
s502* s380::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
if( s.find( L"Null" ) == 0 )
return s381;
...
: s351( s307, NULL ), s1427( tn )
{ 
s512 = pc;
s513 = s829.s13() ? 0 : s829->s367(); 
}
void s400::s520( s279* s962 )
{
}
s502* s400::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s400( s307 );
}
s502* s400::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
...
else if( s307->s227( s388, (s502*)s389 ) ) {
s512 = s500;
s513 = s829->s367();
}
else
...
void s387::s520( s279* s612 )
{
if( false && s307->s227( s388, (s502*)s389 ) ) {
s512 = s500;
s513 = s829->s367();
}
else {
...
{
std::wostream& buf = *pd;
buf << s4::fill_n_ch( L' ', s202 ) << L"DataRef : " << s388 << endl;
}
const wstring s489 = L"";
s501 s720;
s279::s279( s269* s307, s1172 s355, s490 pc/* = s491*/, const s270* ast_ )
: s502( s307, pc, ast_ ), ns( NULL ), s362( s489 ), //s662( s720 ),
s657( NULL )
{
s653 = this;
s513 = s355;
...
: s502( proto.s307, proto.s512, ast_ ), s653( &proto ), ns( proto.ns ), s362( proto.s285 ),
...
: s502( s307, pc, ast_ ), ns( NULL ), s362( s489 ), s285( s709 ),
s657( NULL )//, s662( *new s501() )
{
s653 = this;
}
s279::s279( s270& s737, s269* s307, s490 pc, s279* ns_, s560 am, 
s651& cl, s650& cnl, s652& al )
: s502( s307, pc, &s737 ), s654( NULL ), ns( ns_ ), s362( s737.s306() ), s285( s737.s305() ),
s656( am ), s657( NULL ) //,s662( *new s501() )
{
...
s502* s279::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
return s664( s737, s347 );
}
...
s502* s279::s664( const s270& s737, const std::wstring& s347 )
{
vector<wstring> s724;
vector<s278*> s281;
...
if( !s725 )
throw new s17( L"Arguments passed to a class without init function." );
else {
wstring str = s737.s298();
if( str[pos_ + 1] != L' ' )
str.insert( pos_ + 1, L" " );
str = str.substr( pos_ ).insert( 1, s7::s444 );
s270 ast_( s7::s445, s145( str ) );
...
s502* s279::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s279( *(s279*)this );
}
...
s585* s616::s1237( const s270& s737, s269* s307, s279* obj, 
const wstring& s582 )
{
const s270::s282& s738 = s737.s300();
size_t s733 = s738.size();
...
s616* s616::s625( s585* cs, s269* s307, s279* s613, s616* s220, 
const wstring& s582 )
{
...
if( pl == string::npos ) {
if( s626 == s239 || s626 == s263 || s626 == s264 ||
s626 == s260 || s626 == s266 || s626 == s267 ||
s626 == s875 || s626 == s805 || s626 == s258
|| s626 == s925 || s626 == s988 )
return s307->s219( cs->s306(), cs->s627(), s613, s220, cs->s628() );
s278* par = NULL;
if( s281.size() ) {
par = s281[0];
s490 pc = par->s514();
...
s616* BIFunc = s307->s219( s626, s281, s613, s220, cs->s628() );
if( BIFunc )
return BIFunc;
}
else {
...
s1036 ast2 = new s270( s647, cs->s628()->Nqj() );
...
s616::s616( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l,
const s270* s737 )
...
s616::s616( const s616& right, s279* s617, s616* s618,
const std::vector<s278*>& s741, const s270* s737 )
: s279( right.s307, right.s513, right.s512, s737 ), s285( right.s285 ), 
...
/*s643 s744,*/ s1172 s745, const wstring& methName, const s270* s737 )
...
s912::s912( const s912& right, s279* s617, s616* s618,
const std::vector<s278*>& s741, const s270* s737 )
...
if( s599 == s590 && n == 1 ) {
s616::s1393( s281,
( (s351*)s307->TR().s1108( s281[0]->s367() ) )->s1335( s285 ) );
}
if( par->s514() == s493 ) {
...
s609[n] = s625( cs, s307, s613, this, s613->s306() );
}
...
bool
s616::s580( const wstring& s709, s387* ref,	const wstring& s347 ) const
{
bool s718 = false;
wstring s285 = s709;
...
buf << s4::fill_n_ch( L' ', s202 + s435 ) << L"Local map : " << endl;
s656.s311( pd, s202 + s435 );
...
s375::s375( s269* s307, s279* s617, const std::vector<s278*>& l, const s270* ast_ )
: s351( s307, ast_ )
{
for( auto s : l ) {
s504 p = s278::s1122( s307, s, s617, NULL, s617->s305() );
s364 += p->to_wstring();
}
if( l.empty() )
wh = s7::s943;
...
s502* s375::s371( s279* s613, const std::vector<s278*>& l ) const
{
...
{ s1240( { s1289 } ) }, 1, 1 )));
s363.insert( make_pair( L"read", new s352( L"read", &s375::s425, s1285,
{ s1240( { } ) }, 0, 0 )));
s363.insert( make_pair( L"match", new s352( L"match", &s375::s1143, s1276,
{ s1240( { s1289 } ) }, 1, 1 )));
}
void s375::s520( s279* s962 )
{
}
...
s502* s375::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
...
if( s.size() ) {
pl = s90.find( s[0] );
if( pl != string::npos && s.back() == s90[pl] )
s = s4::s54( s, wstring( 1, s90[pl] ) );
}
if( s.size() == 2 && s[0] == L'\\' )
s364 = s736( s[1] );
...
{
wstring s96 = L"";//( (s375*)s281[2] )->to_wstring();
wstring s = consutils::s104( s96, false );
*( (s361*)s734 )->s373() = (int)s.size();
((s375*)DR)->s364 = s;
}
...
s874::s874( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l, const s270* s737 )
...
: s351( right.s307, ast_ ), s364( right.s364 )
{
}
s1268::s1268( s269* s307, s279* s613, Iterator* it, const s270* ast_ )
: s351( s307, ast_ ), s364( it )
{
}
s502* s1268::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
wstring s362 = s369();
...
if( s733 )
throw new s17( s732 );
return s371( s613, vector<s278*>() );
}
else
return NULL;
}
s502* s1268::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s1268( s307, L"" );
}
void s1268::s520( s279* s962 )
{
}
void s1268::s365()
{
...
s1041::s1041( s269* s307, const std::vector<s278*>& l )
: s1257( s307, L"" ), s1156( true )
{
wstring s1097 = L"wrong sequence generator syntax";
if( l.empty() || l.size() > 3 )
throw new s17( s1097 + L": no arguments" );
if( l.size() == 1 ) {
end = l[0];		
}
else {
...
void s1041::s520( s279* s962 )
{
wstring s1097 = L"wrong sequence generator syntax";
end = s278::s1122( s307, end, s962, (s616*)s962, s962->s305() );
if( start.s14() )
start = s278::s1122( s307, start, s962, (s616*)s962, s962->s305() );
else {
start = s307->TR().s542( end->s367(), s962, s962->s305() );
start->s520( s962 );
}
if( incr.s14() ) 
incr = s278::s1122( s307, incr, s962, (s616*)s962, s962->s305() );
else {
if( start->s367() == s825->s367() )
...
s1057::s1057( s324* v_, s1028 it )
: v( v_ ), s1360( it ), s1359( (size_t)-1 ), s1315( new s361(NULL, -1) ), 
...
s1057::s1057( s324* v_, s1398 it )
: v( v_ ), s1410( it ), s1359( (size_t)-1 ), s1315( new s361(NULL, -1) ), 
s1314( new s1050(NULL, vector<s278*>( { s1315, s381 } )) )
{
if( v.s14() ) {
...
: v( it->v ), s1360( it->s1360 ), s1359( it->s1359 ), s1315( new s361(NULL, 0) ), 
...
s1053::s1053( s794* v_, s1028 it )
: v( v_ ), s1360( it ), s1359( (size_t)-1 ), s1315( new s361( NULL, 0 ) )
{
if( v.s14() ) {
s1359 = std::distance( v->s329().begin(), it );
assert( s1359 >= 0 );
...
s1027::s1027( s333* v_, s1028 it )
: v( v_ ), s1360( it ), s1315( s381 ), s1314( new s1050( NULL, 
...
s401::s401( s269* s307 )
: s337( s307, NULL ), s1074( false ), s1075( false ), s1087( 0 )//, s969( false )
{
s513 = s865.s13() ? 0 : s865->s367();
s1394 = new s361( s307, 0 );
s1395 = new s361( s307, -1 );
s1317 = new s361( s307, 0 );
}
s401::s401( int _beg, int _end )
: s337( NULL, NULL ), s1074( false ), s1075( false ), s1087( 0 )//, s969( false )
{
s1394 = new s361( s307, _beg );
s1395 = new s361( s307, _end );
s513 = s865->s367();
s1317 = new s361( s307, 0 );
}
s401::s401( s269* s307, const wstring& s79, const s270* ast_ )
: s337( s307, ast_ ), s1074( false ), s1075( false ), s1087( 0 )//, s969( false )
{
}
s401::s401( const s401& r, const s270* ast_ )
: s337( r.s307, ast_ ), s1391( r.s1391 ), s1392( r.s1392 ), s1074( false ), 
s1075( false ), s1087( r.s1087 ), s1317( r.s1317 )//, s969( r.s969 )
{
s513 = r.s513;
}
vector<wstring> s1040( { L"i:", L"v:", L"from:", L"to:", L"where:", L"do:", L"in:" } );
s401::s401( s269* s307, s279* s617, const vector<s278*>& l_, const s270* ast_ )
: s337( s307, ast_ ), s1074( false ), s1075( false ), s1087( 0 ), 
s1317( new s361( s307, 0 ) )//, s969( false )
{
s513 = s865->s367();
if( l_.empty() )
return;
...
for( size_t n = 0; n < l_.size() && s1084 < s1164; ++n ) {
if( l_[n]->s514() == s1174 ) {
s1::s9<s387> rf = (s387*)l_[n];
if( rf->Id() == s1373 ) s1084 = 1;
else if( rf->Id() == s1381 ) s1084 = 2;
if( rf->Id() == s1382 ) {
if( n == 1 )
s1074 = true;
else
...
s502* s401::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
wstring s362 = s369();
...
return s371( s613, s281 );
if( s307->TR().s1117( s281[0]->s367(), L"is", L"container" ) ||
s307->TR().s1117( s281[0]->s367(), L"is", L"ordered" ) ||
s307->TR().s1117( s281[0]->s367(), L"is", L"indexed" ) ) {
return new s1257( s307, s613, s281 );
}
else
return new s1041( s307, s281 );
return new s1257( s307, fi, la, in );
}
else
return NULL;
}
void s401::s520( s279* s962 )
{
...
s1394 = s278::s1122( s307, s1394, s962, NULL, s962->s305() );
}
else
s1394 = s381.s16<s503*>();
if( s1395.s14() ) {
...
s1395 = s278::s1122( s307, s1395, s962, NULL, s962->s305() );
}
else
s1395 = s381.s16<s503*>();
s335 = s825->s367();
...
{ s1240( { } ) }, 0, 0 ) ) );
s307->TR().s1064( s513, L"is", L"iterable" );
s307->TR().s1302( s513, L":ContainerForward" );
}
...
s1172 s401::s1332( const wstring& methName, const vector<s504>& l ) const
{
s1172 s718 = 0;
if( methName == L"new" ) {
s718 = s351::s1291();
...
s502* s401::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s401( s307, s613, l );
}
inline bool
...
if( s617->s1262() >= 1 && sec->operator<( fir ) ) {
( (s1243*)fir )->reverse();
( (s1243*)sec )->reverse();
}
...
for_each( s281 + 2, s281 + s518, [&v]( s502* s364 ) 
{ return v.push_back( (s278*) s364 ); } );
*s281 = (s502*) new s401( NULL, NULL, v );
}
...
{
std::wostream& buf = *pd;
buf << s4::fill_n_ch( L' ', s202 ) << L"Range : " << 
s1391 << L", " << s1392 << L", " << s326 << endl;
}
vector<wstring> s1258( { L"i:", L"v:", L"from:", L"to:", L"where:", L"do:", L"in:" } );
s1257::s1257( s269* s307, const wstring& s79, const s270* ast_ )
: s337( s307, ast_ ), s1086( L"@it", s307 ), s364( new s361( s307, 0 )), 
s718( new s361( s307, 0 ))
{
s513 = s1259.s13() ? 0 : s1259->s367();
}
s1257::s1257( s269* s307, long fi, long la, long in, const s270* ast_ )
: s337( s307, ast_ ), s1086( L"@it", s307 ), s364( new s361( s307, 0 ) ), 
s718( new s361( s307, 0 )),
fir( new s361( s307, fi ) ), las( new s361( s307, la ) ), inc( new s361( s307, in ) )
{
s513 = s1259->s367();
}
s1257::s1257( s269* s307, s504 fi, s504 la, s504 inc, const s270* ast_ )
: s337( s307, ast_ ), s1086( L"@it", s307 ), s364( new s361( s307, 0 ) ), 
s718( new s361( s307, 0 )), fir( fi ), las( la ), inc( inc )
{
s513 = s1259->s367();
}
s1257::s1257( const s1257& r, const s270* ast_ )
: s337( r.s307, ast_ ), s1086( L"@it", s307 ), s364( new s361( s307, 0 ) ), 
s718( new s361( s307, 0 ) )
{
...
s1257::s1257( s269* s307, s279* s617, const vector<s278*>& l_, const s270* ast_ )
: s337( s307, ast_ ), s1074(false), s1075(false),s1086( L"@it", s307 ),
s364( new s361( s307, 0 ) ),	s718( new s361( s307, 0 ) ),	fir( new s361( s307, 0 ) ), 
inc( new s361( s307, 1 ) )
{
if( l_.empty() )
return;
TDException s1061( s7::CLFilterVal_ctor1, s1020, ast_ );
if( l_.size() > 9 )
throw s1061.s1099( L"too many arguments" );
s616::s1393( ( vector<s278*>& )l_, s1258 );
const size_t s1164 = 6;
std::vector<s278*> l(s1164);
if( l_.size() ) {
if( !s307->TR().s1124( l_[0]->s367() ) )
...
s1::s9<s387> rf = (s387*)l_[n];
if( rf->Id() == s1375 ) 
throw s1061.s1099( L"'in' determiner is misplaced " + l_[0]->s369() );
else if( rf->Id() == s1373 ) s1084 = 1;
else if( rf->Id() == s1381 ) s1084 = 2;
else if( rf->Id() == s1384 ) s1084 = 3;
else if( rf->Id() == s1369 ) s1084 = 4;
if( rf->Id() == s1382 ) {
if( n == 1 )
s1074 = true;
else
...
else if( l_[n]->s514() == s500 ) {
if( l_[n] == s951 ) s1084 = 5;
}
else
l[s1084++] = l_[n];
}
...
s1183 = (s502*)l[5];
if( s1183.s13() )
throw s1061.s1099( L"return type is missing" );
}
s502* s1257::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
wstring s362 = s369();
if( s.find( s362 ) == 0 && ( s.size() == s362.size() || s[s.size() - 1] == L')' ) ) {
...
s613 = s278::s1122( s307, s613, s962, NULL, s962->s305() );
s1083 = s613.s16<s502*>();
}
s1172 s1119, s1218;
if( s1083->s514() == s492 ) {
s1119 = s1083.s16<s337*>()->s1025();
s1218 = s1083.s16<s337*>()->ValType();
}
else if( s1083->s514() == s499 ) {
wstring s1203 = s307->TR().s1106( s1083->s367(), s7::s1002 );
s1119 = s307->TR().s1111( s1203 );
s1203 = s307->TR().s1106( s1083->s367(), s7::s1004 );
s1218 = s307->TR().s1111( s1203 );
}
else
...
if( start.s14() ) {
if( start->s514() == s493 )
start.s16<s387*>()->s520( s962 );
else
start = s278::s1122( s307, start, s962, NULL, s962->s305() );
if( start->s367() != ( s1074 ? s1218 : s1119 ) )
throw s1061.s1099( wstring( L"start element doesn't match the container's " ) +
( s1074 ? L"value" : L"index" ) + L" type");
}
else
start = s381.s16<s503*>();
/*else {
start = s307->s222( start->s367(), s962->s305() );
start->s520( s962 );
}*/
if( stop.s14() ) {
if( stop->s514() == s493 )
stop.s16<s387*>()->s520( s962 );
else
stop = s278::s1122( s307, stop, s962, NULL, s962->s305() );
if( stop->s367() != ( s1075 ? s1218 : s1119 ) )
throw s1061.s1099( L"the stop element doesn't match the container's " +
wstring( ( s1075 ? L"value" : L"index" ) ) + L"type" );
}
else
stop = s381.s16<s503*>();
if( where.s14() ) {
...
where = s278::s1122( s307, where, s962, (s616*)s962, s962->s305() );
}
if( s1181.s14() ) {
if( s1181->s514() == s493 )
...
if( s1183.s14() ) {
if( s1183->s514() == s493 )
throw s1061.s1099( L"wrong return type: should be a data type, not reference" );
else
s1183 = (s502*)s278::s1122( s307, s1183, s962, (s616*)s962,
s962->s305() );
}
s1172 s1063 = s1183->s517(0,0)->s367();
s513 = s307->TR().s1155( s869::Cont( { s1259->s367(), s1063 }) );
}
void s1257::s365()
{
...
s502* s1257::s371( s279* s613, const std::vector<s278*>& l ) const
{
if( l.empty() ||
s307->TR().s1124( l[0]->s367() ) ) {
return new s1257( s307, s613, l );
}
else
return new s1041( s307, l );
if( l.size() ) {
if( l[0]->s514() == s493 ) {
l[0]->s520( s613 );
if( s307->TR().s1124( l[0]->s367() ) )
return new s1257( s307, s613, l );
}
}
else {
...
s502* s1257::s371( s279* s613, const std::vector<s1172>& vt ) const
{
size_t n = vt[1], idx = 2;
assert( n == 1 );
...
s869 s1182( s1184[0] );
if( s1184.size() == 2 )
s718->s1183 = s307->TR().s1108( s1184[0] )->s371( s613 );
else
s718->s1183 = s307->TR().s1108( s1184[0] )->s371( s613, s1184 );
return s718;
}
inline bool
...
for_each( s281 + 2, s281 + s518, [&v]( s502* s364 )
{ return v.push_back( (s278*)s364 ); } );
*s281 = ( s502* ) new s1257( NULL, NULL, v );
}
...
{
if( s709 == L"@it" ) {
ref->s395( 0, s307->TR().s1108( s1083.s16<s337*>()->ValType() ));
ref->s398( (s502*)this );
return true;
}
...
s351::s356 s321<_Cont, Der>::s363;
template <class _Cont, class Der>
void s321<_Cont, Der>::s365()
{
s363.insert( make_pair( L"size", new s352( L"size", &s321<_Cont, Der>::s340, s1285,
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"max-element", new s352( L"max-element", &s321<_Cont, Der>::s1357,
s1287,	{ s1240( { s1280 } ) }, 1, 1 ) ) );
s363.insert( make_pair( L"max-element-idx", new s352( L"max-element-idx", &s321<_Cont, Der>::s1356,
s1287,	{ s1240( { s1280 } ) }, 1, 1 ) ) );
s363.insert( make_pair( L"clear", new s352( L"clear", &s321<_Cont, Der>::s342, s1287,
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"reverse", new s352( L"reverse", &s321<_Cont, Der>::s1406, s1287,
{ s1240( { s1280 } ) }, 1, 1 ) ) );
s1172 tp = s1286;
s363.insert( make_pair( L"sort", new s352( L"sort", &s321<_Cont, Der>::s1419, s1287,
{ s1240( { s1280 } ), s1240( { s1280, tp } ), 
...
template <class _Cont, class Der>
s1172 s321<_Cont, Der>::s1332( const wstring& methName, const vector<s504>& l ) const
{
s1172 s718 = 0;
if( methName == L"max-element" )
s718 = ValType();
else if( methName == L"max-element-idx" )
s718 = s1025();
return s718;
}
template <class _Cont, class Der>
void s321<_Cont, Der>::s1406( s502** s281, size_t s518 )
{
using s1248 = s1308;
using s1028 = typename Der::s1263;
s1248* pv = ( (s1248*)s281[1] );
if( ( (s337*)pv )->s1262() < 1 )
throw new s17( L"this type of iterable doesn't support the 'reverse' operation" );
typename _Cont::iterator vbeg, vend;
if( s518 == 3 ) {
s401* rv = (s401*)s281[2];
s401::s1269 pr = rv->s1338( pv );
vbeg = pr.first.s16<s1028*>()->s1270();
vend = pr.second.s16<s1028*>()->s1270();
}
else {
vbeg = pv->s364.begin();
vend = pv->s364.end();
}
std::reverse( vbeg, vend );
}
...
template <class _Cont, class Der>
void s321<_Cont, Der>::s1419( s502** s281, size_t s518 )
{
using s1248 = s1308;
using s1028 = typename Der::s1263;
s1248* pv = ( (s1248*)s281[1] );
if( ( (s337*)pv )->s1262() < 2 )
throw new s17( L"this type of iterable doesn't support the 'sort' operation" );
s401* rv = NULL;
s616* s1352 = NULL;
for( size_t n = 2; n < s518; ++n ) {
s502* par = s281[n];
if( par->s514() == s492 )
rv = (s401*)s281[n];
else if( par->s514() == s1396 )
s1352 = (s616*)s281[n];
}
s1296 cmp_;// ( s507( s1352 ) );
cmp_.s932 = s1352;
if( rv ) {
s401::s1269 pr = rv->s1338( pv );
if( pv->s1262() >= 1 && pr.first.s16<s1243*>()->Reversed() ) {
typename _Cont::reverse_iterator vbeg, vend;
vbeg = pr.first.s16<s1028*>()->s1271();
vend = pr.second.s16<s1028*>()->s1271();
std::sort( vbeg, vend, cmp_ );
}
else {
typename _Cont::iterator vbeg, vend;
vbeg = pr.first.s16<s1028*>()->s1270();
...
std::sort( pv->s364.begin(), pv->s364.end(), cmp_ );
}
}
template<class _Cont, class Der>
void s321<_Cont, Der>::s1357( s502** s281, size_t s518 )
{
using s1248 = s1308;
using s1028 = typename Der::s1263;
s1248* pv = ( (s1248*)s281[1] );
...
typename _Cont::iterator s1358 = std::max_element( vbeg, vend, _cmp );
s504 pp = *s1358;
*s281 = pp.s16<transd::s502*>();
}
template<class _Cont, class Der>
void s321<_Cont, Der>::s1356( s502** s281, size_t s518 )
{
using s1248 = s1308;
using s1028 = typename Der::s1263;
s1248* pv = ( (s1248*)s281[1] );
...
auto s1358 = std::max_element( vbeg, vend, _cmp );
s1028 it( pv, s1358 );
s281[0] = pv->s1334( &it );
}
...
#define DR ((s503*)*(s281 + 1))
#define PARN(n)((s503*)*(s281 + n))
s324::s324( s269* s307, s279* s613, const wstring& s79, const s270* ast_,
const wstring& s74 )
: s321( s307, ast_ )
{
TDException s1061( s7::CLVecVal_ctor1, s1020, ast_ );
s1344 = s825->s367();
if( s79.size() ) {
s1300( s79, s613, s74 );
}
...
s324::s324( s269* s307, const std::vector<s278*>& l, const s270* ast_ )
: s321( s307, ast_ )
{
s1344 = s825->s367();
s513 = s765.s13() ? 0 : s765->s367();
...
s324::s324( s269* s307, s1172 s1432, const s270* ast_ )
: s321( s307, ast_ )
{
s1344 = s1285;
s335 = s1432;
...
else if( s674.find( L"typedTable" ) != string::npos ) {
s1062( s674, s613, s628() );
}
}
}
...
s1172 s718 = s307->TR().s1155( s613 );
return s718;
}
void s324::s1298( const std::wstring& s1428 )
{
s869::Cont s613;
s513 = s1339( s1428, s613 );
s325 = s613[1];
const s869& s1435 = s307->TR().s1114( s325 );
s335 = s1435.s367( 4 );
return;
s869::Cont vt;
size_t pos = 0;
...
void s324::load( const wstring& s79, s279* s613, const wstring& s74 )
{
...
s502* s324::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s307->TR().s1430( s737 );
wstring sv;
wstring s362 = s369();
if( s[0] == L'[' && s[s.size() - 1] == L']' )
sv = s;
...
return 0;
return new s324( s307, s613, sv, &s737 );
}
void s324::s520( s279* s962 )
{
wstring s79 = L"";
...
void s324::s1062( const wstring& s79, s279* s613, const s270* ast_ )
{
...
if( ops.size() > 2 ) {
s504 s1166 = s278::s1121( ops[2], ast_, s307, s613 );
s1103 = s1166->to_wstring();
}
if( ops.size() > 3 ) {
s504 s1168 = s278::s1121( ops[3], ast_, s307, s613 );
s1142 = s1168->to_wstring();
}
s504 s1173 = s278::s1121( ops[1], ast_, s307, s613 );
str = s1173->to_wstring();
vector<wstring> s857;
...
void s324::s365()
{
s321<s1056, s324>::s365();
s363 = s321<s1056, s324>::s357();
...
{ s1240( { s1285, s1283 } ) }, 2, 2 ) ) );
s363.emplace( make_pair( L"get", new s352( L"get", &s324::s338, 0,
{ s1240( { s1285 } ) }, 1, 1 ) ) );
s363.emplace( make_pair( L"add", new s352( L"add", &s324::s339, s1287,
{ s1240( { s1283 } ) }, 1, 1 ) ) );
...
s307->TR().s1064( s513, L"is", L"indexed" );
s307->TR().s1064( s513, L"is", L"ordered" );
s307->TR().s1302( s513, L":ContainerIndexed" );
s307->TR().s1302( s513, L":ContainerBidir" );
s307->TR().s1302( s513, L":ContainerForward" );
}
s502* s324::s371( s279* s613, const vector<s278*>& l ) const
{
s324* s718 = new s324( s307, s613, L"" );
s718->s513 = s513;
if( l.size() ) {
s718->s325 = (s1172)*((s361*)l[0])->s373();//new s869( v );
}
else
s718->s325 = s325;
return s718;
}
s502* s324::s371( s279* s613, const std::vector<s1172>& vt ) const
{
size_t n = vt[1], idx = 2;
assert( n == 1 );
...
s1172 s324::s1332( const wstring& methName, const vector<s504>& l ) const
{
s1172 s718 = 0;
if( methName == L"get" )
s718 = s335; 
else
s718 = s321::s1332( methName, l );
return s718;
}
inline bool
...
return new s1057( this, it );
return new s1057( this, end( s364 ) );
}
...
{
*s281 = (s502*)(s278*)( (s324*)DR )->s364[(int)*s281[2]];
}
inline void s324::s339( s502** s281, size_t s518 )
{
if( ! ( ( (s324*)DR )->ValType() == s281[2]->s367() ) )
throw new s17( L"unmatched element type" );
( (s324*)DR )->s364.push_back( s281[2]->s350() );
}
...
s502* s324::reverse( bool s969, s910* cmp )
{
s921 s920( s364 );
if( s969 ) {
if( cmp )
...
{
return new s1057( this, s364.begin() );
}
/*
s505 s324::s323()
{
...
*/
s794::s794( s269* s307, s279* s613, const wstring& s79, 
...
s502* s794::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
wstring sv;
wstring s362 = s369();
...
{ s1240( { s1285, s1275, s1288 } ) }, 2, (size_t)-1 ) ) );
...
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"add", new s352( L"add", &s794::s339, s1287,
{ s1240( { s1275, s1288 } ) }, 1, (size_t)-1 ) ) );
...
s307->TR().s1064( s513, L"is", L"container" );
}
s502* s794::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s794( s307, s613, L"" );
}
s502* s794::s371( s279* s613, const std::vector<s1172>& vt ) const
{
assert( 0 );
return 0;
}
s1172 s794::s1332( const wstring& methName, const vector<s504>& l ) const
{
s1172 s718 = 0;
if( methName == L"fst" )
s718 = s364[0]->s367();
else if( methName == L"snd" )
s718 = s364[1]->s367();
else if( methName == L"get" ) {
int n = (int)*l[0];
s718 = s364[n]->s367();
}
return s718;
...
inline void s794::s339( s502** s281, size_t s518 )
{
...
s1050::s1050( s269* s307, s279* s613, const std::wstring& s79, 
...
s502* s1050::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s307->TR().s1430( s737 );
wstring sv;
wstring s362 = s369();
...
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"add", new s352( L"add", &s1050::s339, s1287,
{ s1240( { s1275, s1288 } ) }, 1, (size_t)-1 ) ) );
...
s502* s1050::s371( s279* s613, const std::vector<s1172>& vt ) const
{
...
s502* s1050::s371( s279* s613, const std::vector<s278*>& l ) const
{
s1050* s718 = new s1050( s307, l );	
return s718;
}
...
void s1050::load( const wstring& s79, s279* s613, const wstring& s74 )
{
...
s1172 s1050::s1332( const wstring& methName,  const vector<s504>& l ) const
{
s1172 s718 = 0;
if( methName == L"fst" )
...
inline void s1050::s339( s502** s281, size_t s518 )
{	
s1050* s881 = ( (s1050*)DR );
...
s333::s333( s269* s307, s1172 s1345, s1172 s1431, const s270* ast_ )
: s337( s307, ast_ )
{
assert( s1345 && s1431 );
s1344 = s1345;
...
s333::s333( s269* s307, s279* s613, const wstring& s79, const s270* ast_ )
: s337( s307, ast_ )
{
TDException s1061( s7::CLIndexVal_ctor1, s1020, ast_ );
if( s79.size() ) {
wstring s674, s1428;
...
s502* s333::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s = s737.s298();
wstring si;
wstring s362 = s369();
...
{ s1240( { s1282, s1283 } ) }, 2, 2 ) ) );
s363.insert( make_pair( L"get", new s352( L"get", &s333::s338, 0,
{ s1240( { s1282 } ) }, 1, 1 ) ) );
s363.insert( make_pair( L"get-s", new s352( L"get-s", &s333::s1115, 0,
{ s1240( { s1282, s1283 } ) }, 2, 2 ) ) );
...
{ s1240( { } ) }, 0, 0 ) ) );
s363.equal_range( L"get" ).first->second->s1413( true );
s363.equal_range( L"get-s" ).first->second->s1413( true );
s307->TR().s1064( s513, L"is", L"container" );
}
s502* s333::s371( s279* s613, const std::vector<s278*>& l ) const
{
s1::s9<s333> s718 = new s333( s307, s613, L"" );
s718->s1344 = s1344;
s718->s335 = s335;
return s718;
}
s502* s333::s371( s279* s613, const std::vector<s1172>& vt ) const
{
size_t n = vt[1], idx = 2;
assert( n == 1 );
s869::Cont s1091;
...
s333* s718 = new s333( s307, s1345, s1431, NULL );
return s718;
}
s1172 s333::s1332( const wstring& methName, const vector<s504>& l ) const
{
s1172 s718 = 0;
if( methName == L"get" ) {
s718 = s325;
}
else if( methName == L"get-s" ) {
s718 = s325;
}
return s718;
}
...
{
s333* p = (s333*)DR;
s1026::iterator it = p->s364.find( (s502*)PARN( 2 ) );
if( it == p->s364.end() )
*s281 = NULL;
else {
...
inline void s333::s1115( s502** s281, size_t s518 )
{
s333* p = (s333*)DR;
s1026::iterator it = p->s364.find( (s502*)PARN( 2 ) );
if( it == p->s364.end() ) {
...
if( dr->s1344 != s156->s367() || dr->s335 != s364->s367() )
throw new s17( L"non-compatible types cannot be inserted to an Index" );
s1026::iterator it = dr->s364.find( (s502*)PARN( 2 ) );
if( it == dr->s364.end() ) {
...
vector<wstring> s1045( { L":asc", L":desc", L":a", L":d", L":ascending", L":descending" } );
s909::s909( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l, const s270* s737 )
: s616( s307, s617, s618, s589, s926, s737 ), s932( NULL )
{
if( l.size() < 1 || l.size() > 3 )
throw new s17( L"malformed syntax of 'sort' procedure call." );
s281.assign( l.begin(), l.end() );
s513 = s1287;
s616::s1393( ( vector<s278*>& )l, s1045 );
}
void
s909::s520( const wstring& s347, bool proc )
{
reverse = false;
size_t idx = 1;
while( s281.size() > idx ) {
...
s490 pc = par_->s514();
if( pc == s1174 ) {
if( par_.s16<s387*>()->s644()[0] == L'd' )
reverse = true;
}
else if( par_->s514() == s496 ) {
s509 cs = new s585( *par_.s16<s585*>() );
s932 = s625( cs, s307, s613, this, s305() );
}
else
throw new s17( L"malformed syntax of 'sort' procedure call." );
s281.erase( s281.begin() + idx );
}
s616::s520( s347, proc );
if( s932 )
s932->s520( s347, false );
}
s505 s909::s517( s502** s741, size_t s518 )
{
s490 pc = s281[0]->s514();
s1::s9<s337> s613;
if( pc == s494 ) {
...
s910 cmp_( s932 );
return s613->sort( reverse, s932.s14() ? &cmp_ : nullptr );
}
s278* s909::s350()const
{
return new s909( *this );
}
vector<wstring> s1274( { L"index:", L"value:", L"cmpFunc:" } );
s1273::s1273( s269* s307, s506 s617, s507 s618, 
const std::vector<s278*>& l_, const s270* s737 )
: s616( s307, s617, s618, s589, /*s1304*/L"", s737 ), s1346(false),
s989( NULL )
{
TDException s1061( s7::CLTDMaxElement_ctor1, s1019, s737 );
if( l_.empty() || l_.size() > 5 )
throw s1061.s1099( L"wrong number of arguments" );
s616::s1393( ( vector<s278*>& )l_, s1274 );
...
else if( rf->Id() == s1383 ) s1084 = 2;
else if( rf->Id() == s1366 ) s1084 = 2;
}
else
l[s1084++] = l_[n];
}
if( !l[2] ) {
if( !s307->TR().s1350( l[0]->s367() ) )
throw s1061.s1099( L"the range is not ordered: " + l[0]->s369() );
}
range = l[0];
s989 = (s616*)l[2];
}
void
s1273::s520( const wstring& s347, bool proc )
{
size_t idx = 1;
while( s281.size() > idx ) {
s504 par_ = s281[idx];
s490 pc = par_->s514();
if( pc == s1174 ) {
if( par_.s16<s387*>()->s644() == L":cmpFunc" )
(void)0;
}
else if( par_->s514() == s496 ) {
s509 cs = new s585( *par_.s16<s585*>() );
s989 = s625( cs, s307, s613, this, s305() );
}
else
throw new s17( L"malformed syntax of 'TDMaxElement' procedure call." );
s281.erase( s281.begin() + idx );
}
if( s1346 )
s513 = ((s337*)range->s516())->s1025();
else
s513 = ((s337*)range->s516())->s328();
s616::s520( s347, proc );
if( s989 )
s989->s520( s347, false );
}
s505 s1273::s517( s502** s741, size_t s518 )
{
s490 pc = range->s514();
s1::s9<s337> s1400;
if( pc == s494 ) {
s1400 = range->s517( 0, 0 ).s16<s337*>();
}
else
s1400 = ( (s337*)range.s16<s387*>()->s393() );
s505 s718, s1319;
Iterator* s1125 = s1400->s322( NULL );
s504 p = s1125->s323();
if( s1346 )
s718 = (s502*)((s1261*)s1125)->Idx();
else
s718 = p.s16<s502*>();
s1319 = p.s16<s502*>();
while( 1 ) {
...
s278* s1273::s350()const
{
return new s1273( *this );
}
#define DR ((s503*)*(s281 + 1))
#define PARN(n)((s503*)*(s281 + n))
s431::s431( s269* s307, const wstring& s79, const s270* ast_ )
: s351( s307, ast_ ), s799( s307, s1289, NULL ), s862( s307, s1289, NULL )
{
...
: s351( right.s307, ast_ ), s799( right.s307, NULL, L"" ), s862( right.s307, NULL, L"" )
{
s799 = right.s799;
s862 = right.s862;
s513 = right.s513;
}
s502* s431::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
return new s431( s307, L"" );
}
void s431::s520( s279* s962 )
{
size_t pos = 0;
s869::Cont s1434;
...
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"files", new s352( L"files", &s431::s433, 0 /*s765->s367()*/,
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"dirs", new s352( L"dirs", &s431::s1089, 0 /*s765->s367()*/,
{ s1240( { } ) }, 0, 0 ) ) );
s363.insert( make_pair( L"size", new s352( L"size", &s431::s340, s1285,
{ s1240( { } ) }, 0, 0 ) ) );
}
s502* s431::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s431( s307, L"" );
}
inline bool
...
void Stream::write( s504 )
{ throw new s17( L"not implemented" ); };
s528::s528( s269* s307, const s270* ast_ )
: s351( s307, ast_ )
{
s513 = s871.s13() ? 0 : s871->s367();
}
s528::s528( const s528& r, const s270* ast_ )
: s351( r.s307, ast_ ), ss( r.ss.str() )
{
s513 = s871->s367();
}
s502* s528::s371( s279* s613, const std::vector<s278*>& ) const
{
return new s528( s307 );
}
void s528::s365()
{
...
void s528::s520( s279* s962 )
{
}
s502* s528::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
wstring s_ = s737.s298();
...
s630::s630( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s312::s312( s269* s307, s279* s617, Transd* s618, const std::vector<s278*>& l, const s270* s737 )
...
s315::s315( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s641::s641( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, 
const s270* s737 )
: s616( s307, s617, s618, s589, s266, s737 ),
s319( s7::s478, s307 ), s320( s307, 0 )
{
wstring s747 = L"malformed syntax of 'for' statement: ";
if( l.size() < 5 )
...
s278* p = l[0];
if( p->s514() != s493 )
throw new s17( s747 + L"the variable must be a name." );
s749 = (s387*) l[0];
varval = s381.s16<s502*>();
s387* in = (s387*) l[1];
if( in->s644() != L"in" )
throw new s17( s747 + L"the 'in' keyword is missing." );
s316 = l[2];
p = l[3];
size_t idx = 3; 
wstring actmsg = s747 + L"the ACTION clause is non-conforming: should begin with 'select' " +
...
throw new s17( s747 + L"unknown iterable type." );
...
throw new s17( s747 + L"PREDICATE must be a function." );
}
if( select ) {
pc = select->s514();
if( pc == s496 ) {
...
s629::s629( s269* s307, s279* s613, s616* s612, const std::vector<s278*>& l,
const s270* s737 )
...
{
if( s599 == s593 && s724[0]->s367() != s513 ) {
s1172 type = s724[0]->s367();
s884* pt = (s884*)&types[0];
for( size_t n = 0; n < types.size(); ++n ) {
if( pt[n] == type )
return s679[n]->s517( s724, s733 );
}
throw new s17( L"dispatching failed" );
}
else {
...
s907::s907( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s502* s907::s371( s279* s613, const std::vector<s1172>& vt ) const
{
...
s632::s632( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s633::s633( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
: s616( s307, s617, s618, s589, s249, s737 )
{
s281.assign( l.begin(), l.end() );
s513 = s803->s367();
...
s634::s634( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
vector<wstring> s1047( { L"to:" } );
s635::s635( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s281.assign( l.begin(), l.end() );
s513 = s781->s367();
s616::s1393( ( vector<s278*>& )s281, s1047 );
}
s635::s635( s269* s307 )
...
if( s43 )
s43.dcast<Stream*>()->write( s157 );
else
wcout << s157->to_wstring();
}
return s381;
}
...
s908::s908( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s984::s984( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s637::s637( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s638::s638( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s639::s639( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s640::s640( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
: s616( s307, s617, s618, s589, s267, s737 )
{
wstring s362 = ((s387*)l[0])->s644();
std::vector<s278*> v1( l.begin() + 1, l.end() );
s281.assign( l.begin() + 1, l.end() );
s1036 ast_ = new s270( s362 + L"()", s628()->Nqj() );
s646 = s307->TR().s542( *ast_, s617, s613->s305() );
s611 = s646;
s513 = s646->s367();
}
void
s640::s520( const wstring& s347, bool proc )
{
s724.assign( s281.begin(), s281.end() );
return;
s616::s520( s347, proc );
for( size_t n = 0; n < s281.size(); ++n ) {
s724.push_back( s281[n] );
}
}
s505 s640::s517( s502** s741, size_t s518 )
{
for( size_t n = 0; n < s281.size(); ++n ) {
if( s281[n]->s514() == s493 ) {
s387* rf = s281[n].s16<s387*>();
if( rf->s397().s13() ) {
try {
rf->s520( this );
}
...
else if( s281[n]->s514() == s494 )
s724[n] = s281[n].s16<s616*>()->s517( NULL, 0 ).s16<s503*>();
}
s718 = s646->s371( this, s724 );
s718->s520( this );
return s718;
}
bool
s640::s580( const wstring& s709, s387* ref, const wstring& s347 ) const
{
if( (s718.s14() ? s718 : s646)->s580( s709, ref, s347 ))
return true;
return s616::s580( s709, ref, s347 );
}
s800::s800( s269* s307, s279* s617, s616* s618, const std::vector<s278*>& l, const s270* s737 )
...
s636::s636( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l, const s270* s737 )
...
s269* s642::s994 = NULL;
s642::s642( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l, const s270* s737 )
...
s849::s849( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l, const s270* s737 )
...
s824::s824( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l, 
const s270* s737 )
...
: s351( right.s307, ast_ )
{
s513 = right.s513;
}
s502* s680::s370( const s270& s737, s279* s613, const std::wstring& s347 )
{
return new s680( s307, L"" );
}
void s680::s520( s279* s962 )
{
}
void s680::s365()
{
...
s502* s680::s371( s279* s613, const std::vector<s278*>& l ) const
{
return new s680( s307, L"" );
}
inline bool
...
s842::s842( s269* s307, s506 s617, s507 s618, const std::vector<s278*>& l_, const s270* s737 )
...
p = l[1];
if( p->s514() != s493 )
throw s1061.s1099( L"the query verb is missed." );
verb = p.s16<s387*>();
if( verb->s644() != L"select" && verb->s644() != L"SELECT")
throw s1061.s1099( L"unrecognized verb." );
p = l[2];
if( p->s514() == s493 || p->s514() == s494 || p->s514() == s1174 )
what = p;
else if( p->s367() == s843->s367() ) {
what = p;
}
else if( p->s367() == s765->s367() )
what = p;
else
...
p = l[3];
if( p->s514() != s493 )
throw s1061.s1099( L"the 4-th query constituent is unrecognized." );
rf = p.s16<s387*>();
if( rf->s644() == L"required" ||  rf->s644() == L"REQUIRED" ) {
s834 = 4;
if( l.size() < 5 )
throw s1061.s1099( L"the 'required' clause must contain a vector of required fields." );
s792 = (s324*) l[4];
if( s792->s367() != s765->s367() )
throw s1061.s1099( L"the 'required' clause must be a vector of required fields." );
if( l.size() > 5 ) {
p = l[5];
if( p->s514() != s493 )
throw s1061.s1099( L"a modifier (the 6-th query constituent) is unrecognized." );
rf = p.s16<s387*>();
s834 = 6;
}
}
if( rf->s644() == L"where" ||  rf->s644() == L"WHERE" ) {
s834 = 4;
if( l.size() < s834 )
throw s1061.s1099( L"the 'where' clause must contain an expression." );
where = l[s834];
if( where->s514() != s496 )
throw s1061.s1099( L"the 'where' clause must be an expression." );
if( l.size() > s834 + 1 ) {
p = l[++s834];
if( p->s514() != s493 )
throw s1061.s1099( L"a modifier (the 6-th query constituent) is unrecognized." );
...
enum s892 { s954, s956, s955 };
s892 s935 = s954;
while( s834 < l.size() ) {
s504 par_ = l[s834];
s490 pc = par_->s514();
if(	pc == s493 ) {
wstring s1230 = par_.s16<s387*>()->s644();
if( s1230 == L"distinct" || s1230 == L"DISTINCT")
s863.distinct = 1;
else if( s1230 == L"limit" ||  s1230 == L"LIMIT" ) {
if( l.size() < s834 )
throw s1061.s1099( L"the 'limit' clause must contain a value." );
s953 = l[++s834];
}
else if( s1230 == L"sortby" ||  s1230 == L"SORTBY" ) {
if( l.size() < s834 )
throw s1061.s1099( L"the 'sortby' clause must contain a value." );
par_ = l[++s834];
if( par_->s367() != s843->s367() )
throw s1061.s1099( L"the 'sortby' value must be a field name." );
s863.s973 = par_.s16<s375*>()->to_wstring();
s863.s974 = s786::s906::s889;
s935 = s956;
}
else if( s1230 == L"ascending" || s1230 == L"ASCENDING" || s1230 == L"asc" ||
s1230 == L"ASC") {
if( s935 != s956 )
throw s1061.s1099( L"modifier '" + s1230 + L"' is not valid in this position." );
s935 = s954;
s863.s974 = s786::s906::s889;
}
else if( s1230 == L"descending" || s1230 == L"DESCENDING" || s1230 == L"desc" ||
s1230 == L"DESC") {
if( s935 != s956 )
throw s1061.s1099( L"modifier '" + s1230 + L"' is not valid in this position." );
s935 = s954;
...
wstring s747 = L"Error during execution of query: ";
