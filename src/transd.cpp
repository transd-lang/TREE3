...
return s717;}
return s380;}
vector<wstring> s1045( { L"to:", L":sign", L":nosign", L"width:", L"prec:", L"fill:", 
L":left", L":right", L":internal", L":fixed", L":group", L":nl" } );
...
const vector<s277*>& s2101, const wstring& s708, const s269* s736 )
