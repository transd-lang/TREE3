...
s120 = _getch();
s120 = s118;}
else if( s120 == 70 ) s120 = s1731;
else if( s120 == 72 ) s120 = s1732;
else if( s120 == 54 || s120 == 53 ) {
s120 = _getch();
continue;}}
else if( s120 == 10 )
s120 = 13;
...
const wstring s2123 = L"pipe";
const wstring s1736 = L"lout";
const wstring s2122 = L"lin";
...
s55( s78, s69, L'{', L'}', s713, s714, true );
if( s714 == s76 )
throw new s16( L"Curly brackets don't match near \'" + s78.substr( s69, 40 ) + L"...\'" );
s712 = s78.substr( s69, s714 - s69 + 1 );
s715 = s714 + 1;}
else if( s78[s69] == L'"' ) {
s56( s78, s69, L'"',
...
s717 = s237;
else if( s78[pos] == L'-' && s78[pos + 1] != L'=' && s78[pos + 1] != L'|')
s717 = s241;
...
wstring TDException::s2091( const s269& s736 ){
size_t s1139 = 0;
wstring file, s1193, s717;
...
return s717;}
s503
s277::s1119( s2084& s78, const s269* ast_, s268* s306, s278* s612 ){
s1034 ast1;
if( ast_ )
...
s501* s501::s515(){
return this;}
void s501::s2139( s2084&) { throw std::logic_error( "from_wstring: not implemented" ); }
...
assert(0);
return 0;}
s1170 s501::s1331( s2084& s1727, const vector<s503>& l ) const{
throw std::logic_error( "9: not implemented" );}
s615* 
s501::s1862( s2084& s708, s615* s219,
s584* cs ) const{
if( s708 == L"cp" ) {
return new s1857( s306, (s278*)this, s219, &s501::s1881, cs->s626(),
L"cp",	0, cs->s627() );}
else if( s708 == L"exec" ) {
return new s1857( s306, ns, s219, &s501::s2073, cs->s626(), L"exec",
0, cs->s627() );}
else if( s708 == L"_META_type" ) {
return new s1857( s306, ns, s219, &s501::s2117, cs->s626(), 
L"_META_type", s1288,	cs->s627() );}
return NULL;}
s501* s501::s1881( s501** s280, size_t s517 ){
return (s501*)s349();}
s501* s501::s2073( s501** s280, size_t s517 ){
return s516( s280, s517 );}
s501* s501::s2117( s501** s280, size_t s517 ){
return new s374( s306, s368() );}
...
void s501::s2114( Stream* s2113 ) const{
s2113->s1654( to_wstring() );}
void s501::s2138( Stream* s2113 ){
wstring s;
s2113->s1635( s, string::npos );
s2139( s );}
...
s400::proto = new s400( s306 );
s1255::proto = new s1255( s306 );
s1039::proto = new s1039( s306 );
s430::proto = new s430( s306 );
s905::proto = new s905( s306 );
s527::proto = new s527( s306 );
s1450::proto = new s1450( s306 );
s1460::proto = new s1460( s306 );}
...
s306->s223( s430::proto, L"Directory" );
s306->s223( s400::proto, L"Range" );
s306->s223( s1255::proto, L"Filter" );
s306->s223( s1039::proto, L"Seq" );
s306->s223( s1980::proto, L"Table" );
s306->s223( s679::proto, L"TSDBase" );
s306->s223( s527::proto, L"StringStream" );
s306->s223( s1450::proto, L"ByteStream" );
s306->s223( s1460::proto, L"FileStream" );
...
s1265 s350::s1340( s2084& s357 ) const{
s350::s351* s717 = NULL;
auto it = s356().find( s357 );
if( it != s356().end() )
s717 = it->second;
...
s1265
s350::s1335( s2084& s357, s1238& ap /*const vector<s1170>& s1388*/ ) const
{
auto ran = s356().equal_range( s357 );
if( ran.first == s356().end() )
throw new s16( L"No such method: " + s368() + L"::" + s357,
...
return s717 ? s1265( s717->s514(), s717->s1258(), s717->s1347() ) : s1265();}
s1265
s350::s1330( s2084& s357, s1238& ap ){
auto ran = s356().equal_range( s357 );
s351* mi = NULL;
for( auto it = ran.first; it != ran.second; ++it ) {
if( it->second->s1306( ap ) ) {
...
s501* s350::s359( s268* s306, s2084& s363, s2084& s346 ){
s269 s212( s363, NULL );
s501* s717 = NULL;
double dval;
size_t pos = 0;
...
s501* s373::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s736.s297();
...
wh = r.wh;
s512 = r.s512;}
double s2121( s2084& s, size_t& pos ){
assert( !s.empty() );
...
pos = pend - pst;
return s156;}
s373::s373( s268* s306, s2084& s, size_t& pos )
: s350( s306, NULL, NULL ){
if( !s.empty() ) {
s363 = s2121( s, pos );
s1855( s7::s940 );}
...
s362.insert( make_pair( L"incr", new s351( L"incr", &s373::s2157, s1283,
{ s1238( ) }, 0, 0 )));
s362.insert( make_pair( L"decr", new s351( L"decr", &s373::s2156, s1283,
{ s1238( ) }, 0, 0 )));
...
wstringstream ss;
wstring s717;
int prec = s1739 << 28 >> 28;
if( prec ) {
ss << setprecision( prec ) << s363;
s717 = ss.str();}
else {
...
s717 = s.substr(0, pl);}
return s717;}
void s373::s2114( Stream* s2113 ) const{
s1674& ss = s2113->s2143();
/*	auto flags = s2113->s2109();
ss.imbue( std::locale( "C" ) );
ss.flags( flags );
ss.precision( s2113->s2110() );
*/
ss << s363;}
void s373::s2139( s2084& s ){
size_t pos = 0;
s363 = s2121( s, pos );}
void s373::s2138( Stream* s2113 ){
s1671& ss = s2113->s2142();
ss >> s363;}
#undef s733
...
s733->s363 = -t;}
void s373::s2157( s501** s280, size_t s517 ){
double s717 = (double)*DR;
if (isnan( s717 ) || s717 == -INFINITY || s717 == INFINITY) (void)0;
else if ( s717 == 0.0 ) s717 = DBL_EPSILON;
else {
union s2153 {
int64_t i;
double f;
...
s717 = conv.f;}
s733->s363 = s717;}
void s373::s2156( s501** s280, size_t s517 ){
double s717 = (double)*DR;
if (isnan( s717 ) || s717 == -INFINITY || s717 == INFINITY) (void)0;
else if ( s717 == 0.0 ) s717 = DBL_EPSILON;
else {
...
s375::s375( s268* s306, s2084& s, size_t& pos )
: s350( s306, NULL, NULL ){
if( s.empty() )
s363 = s306->TR().s1400();
...
s501* s375::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
*s734->s372() = 0;}
wstring s375::to_wstring( uint32_t s1739 ) const{
return ( s363 ? L"true" : L"false" ); }
void s375::s2114( Stream* s2113 ) const{
s1674& ss = s2113->s2143();
ss << s363;}
void s375::s2139( s2084& s ){
if( s == L"true" || s == L"1" )
s363 = true;
...
inline bool s375::operator<( const s501* p ) const{
return ( s363 < ((s375*)p)->s363 );}
s376::s376( s268* s306, s2084& s/* = std::wstring( L"" )*/ )
...
((s376*)p)->s79 = s79;}
s501* s376::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s736.s297();
...
s501* s379::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s736.s297();
if( s.find( L"Null" ) == 0 )
return s380;
return NULL;}
...
s501* s399::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
bool 
s1884::s1906( s2084& s363, std::tm& t, s1883& s646 ) const{
wsmatch s1183;
s646 = s1919;
...
s501* s1884::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s4::s53( s736.s297(), s4::s49 );
...
return s717;}
s1778::s1778( s268* s306, s278* s612, s2084& s78, const s269* ast_ )
: s350( s306, s612, ast_ ){
if( s78.size() ) {
load( s78, false );}
if( !s512 )
...
s501* s1778::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s736.s297();
...
return s370( s612, std::vector<s277*>(), &s736 );}
return NULL;}
s1170 s1778::s1331( s2084& s1727, const vector<s503>& l ) const{
s1170 s717 = 0;
if( s1727 == L"get" ) {
auto it = s655.get( l[0]->to_wstring() );
s717 = it->s366();}
return s717;}
void s1778::load( s2084& s78, bool s1810 ){
...
s717 += L"\n }";
return s717;}
void s1778::s2139( s2084& s ) {
load( s, false );}
s386::s386( s2084& s, s268* s306, s489 cat, bool _cnst )
...
{ s1238( ), s1238( { s1686::s1425, s7::s1570 } ) }, 1, 1 ) ) );
...
{ s1238( { s1686::s1723 } ) }, 1, 1 ) ) );
s362.insert( make_pair( L"max", new s351( L"max", &s1470<s1478, Der>::s2144, s1699,
{ s1238( { s1686::s1723, s7::s1570 } ) }, 1, 1 ) ) );
s362.insert( make_pair( L"min", new s351( L"min", &s1470<s1478, Der>::s2145, s1699,
{ s1238( { s1686::s1723, s7::s1570 } ) }, 1, 1 ) ) );
...
*s734->s372() = false;}
template<class s1478, class Der>
inline void s1470<s1478, Der>::s2144( s501** s280, size_t s517 ){
Der tmp;
*s733->s372() = ( (Der*)DR )->s363;
for( size_t n = 2; n < s517; ++n ) {
s280[n]->s371( &tmp );
if( *s733->s372() < tmp.s363 )
*s733->s372() = tmp.s363;}}
template<class s1478, class Der>
inline void s1470<s1478, Der>::s2145( s501** s280, size_t s517 ){
Der tmp;
*s733->s372() = ( (Der*)DR )->s363;
for( size_t n = 2; n < s517; ++n ) {
s280[n]->s371( &tmp );
...
s512 = proto->s366();}
s501* 
s360::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
s501* s717 = NULL;
size_t pos = 0;
if( s.find( L"Int(" ) == 0 ) {
...
return s717;}
void s360::s2114( Stream* s2113 ) const{
s1674& ss = s2113->s2143();
ss << s363;}
void s360::to_null(){
s277::to_null();
...
s501* 
s1464::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
if( s.find_first_not_of( L"-0123456789" ) == std::string::npos ) {
size_t pos = 0;
...
s717 += std::to_wstring( s363 );
return s717;}
void s1464::s2114( Stream* s2113 ) const{
s1674& ss = s2113->s2143();
ss << s363;}
...
throw new s16( L"no conversion from " + s368() + L"to " + p->s368() );}
s501* 
s1703::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
if( s.find_first_not_of( L"-0123456789" ) == std::string::npos ) {
size_t pos = 0;
...
s717 += std::to_wstring( s363 );
return s717;}
void s1703::s2114( Stream* s2113 ) const{
s1674& ss = s2113->s2143();
ss << s363;}
...
throw new s16( L"no conversion from " + s368() + L"to " + p->s368() );}
s501* 
s1452::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
size_t pos = 0;
/*if( s.find_first_not_of( L"-0123456789" ) == std::string::npos ) {
size_t pos = 0;
...
lv.s1413();
s280[0] = plv;}
void s1452::s2114( Stream* s2113 ) const{
auto flags = s2113->s2109();
wstringstream ss;
ss.imbue( std::locale( "C" ) );
ss.flags( flags );
...
throw new s16( L"no conversion from " + s368() + L"to " + p->s368() );}
s501* 
s1748::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
size_t pos = 0;
if( s736.s1475() == s366() )
...
return s370( NULL, std::vector<s277*>(), &s736 );}
return 0;}
void s1748::s2114( Stream* s2113 ) const{
auto flags = s2113->s2109();
wstringstream ss;
ss.imbue( std::locale( "C" ) );
ss.flags( flags );
...
p->s519( this, false );
p->s516( 0, 0 );}}
s278::s278( s2084& s708, s268* s306, s489 pc, const s269* ast_ )
: s501( s306, pc, ast_, NULL ), s652(NULL), s653(NULL), 
...
s737.erase( it );}}
s278::~s278(){}
s501* s278::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
s656->s577( s736.s297() );
return;}
void s278::s667( s2084& s346,	vector<wstring>& s156 ){
s655.s556( s346, s156 );}
void s278::s578( s2084& s77, s2084& s581 ){
if( !s656 )
s656 = new s574();
...
bool s278::s579( s2084& sym_, s386* ref, s2084& s346,
bool fr ) const{
bool s717 = false;
wstring sym = sym_;
...
return s717;}
size_t s278::s668( s2084& s676 ) const{
if( s676 == s7::s1777 )
return s1270;
...
return this;
return s657[off];}
void s278::s920( s2084& s77, s501* s363, s500::s148 ap ){
s655.s564( s77, s363, ap );
s657.push_back( s363 );
s658.push_back( s386( s77, s306 ) );}
void s278::s1833( s2084& s77, s501* s363 ){
if( !s655.s159( s77 ) )
...
s501* s278::s670( s2084& sym, s2084& s346,	bool s543/*= true*/ ) const
{
size_t pl = sym.find( L"::" );
if( pl != string::npos ) {
...
s717 = NULL;}
return s717;}
bool s278::s671( const wstring& sym, s2084& s518 ) const{
if( s518 == s361 )
return true;
return s655.s573( sym, s518 );}
s1170 s278::s401( s2084& s357 ) const{
...
s717 = s722->s366();}
return s717;}
s501* s278::s663( const s269& s736, s501* s612, s2084& s346 ) const{
vector<wstring> s723;
vector<s503> s280;
...
s501* s278::s358( s2084& s708, s2084& s346,
...
return NULL;
return ref.s393();}
s615* s278::s1862( s2084& s708, s615* s219,
s584* cs ) const{
if( s708 == L"getf" ) {
return new s1856( s306, (s278*)this, s219, &s278::s1882, cs, 
NULL );}
return s501::s1862( s708, s219, cs );}
...
s615* ptd = s738.s15<s278*>()->s1862( s625, s219, cs );
if( ptd )
return ptd;
...
: s615( s306, s617, s617, ct, L"", s736 ), s2155( false )/*,
s585( s743 )*/
{
s284 = s1727;
s599 = s595;
...
if( s280[n]->s515()->s1347() && !s658[n].s1347() )
...
s1075.resize( s607.size() );
s1413();}
void s615::s2090( const s600& pl ) const{
TDException s1059( s7::s2083, s1730, s627() );
size_t shift = 0;
if( s598 == s591 )
shift = 1;
if( pl.size() > s657.size() + shift )
throw s1059.s1097( L"too many arguments" );
for( size_t n = shift; n < pl.size(); ++n ) {
s503 par = pl[n];
if( s606[n]->s366() == s827->s366() ) {
if( !s606[n]->s521( par.s15<s501*>() ) )
throw s1059.s1097( L"wrong argument type: for #" + std::to_wstring( n ) + L" parameter expected '" +
s606[n]->s368() + L"', received - '" + par->s368() + L"'" );}
else if( !s306->TR().s1708( par->s366(), s606[n]->s366() ) ) {
throw s1059.s1097( L"wrong argument type: for #" + std::to_wstring( n ) + L" parameter expected '" +
s606[n]->s368() + L"', received - '" + par->s368() + L"'" );}
if( par->s644() < 0 && par->s644() != s7::s1925 )
throw s1059.s1097( L"uninitialized function parameter: " + s658[n].s643() );
if( par->s1347() && !s658[n].s1347() )
throw s1059.s1097( L"constant argument is passed to non-constant function: " + s658[n].s643() );}}
...
s501* s615::s1787( s501** s723, size_t s732 ){
int shift = 0;
if( s598 == s588 || s598 == s589 )
shift = 1;
...
if( s1075[n + shift]->s644() < 0 ) {
if( s1075[n + shift]->s644() == s7::s939 )
s1075[n + shift]->s1855( 0 );
else if( s1075[n + shift]->s644() != s7::s1925 )
return s1075[n + shift];}
...
if( s717 )
return s717;
if( !s2155 && s607[1]->s1347() )
throw new s16( L"non-constant function is applied to a constant variable" );
try {
s585( s603, s517 );
s717 = s607[0];}
catch( s16* e ) {
TDException s1059( TDException::Stage::s1136, s7::s1243, 
s1252, past,	*e );
delete e;
s717 = new s376( s306, s1059.Msg() );}
return s717;}
...
s717 = c;}
return s717;}
s501* s374::s369( const s269& s736, s278* s612, 
const std::wstring& s346 ) const{
...
void s374::s2114( Stream* s2113 ) const{
s2113->s1654( s363 );
return;
s1674& ss = s2113->s2143();
ss << s363;}
void s374::s2139( s2084& s ){
s363 = s;}
void s374::s2138( Stream* s2113 ){
s2113->s1635( s363, string::npos );
return;
s1671& ss = s2113->s2142();
ss >> s363;}
...
s512 = s1586;}
s501* 
s400::s369( const s269& s736, s278* s612, const wstring& s346 ) const{
wstring s = s736.s297();
wstring s361 = s368();
...
s1411( s1308 );}
void s400::s364(){
s362.insert( make_pair( L"new", new s351( L"new", &s400::s1384, s1586,
{ s1238( { s1686::s1723 } ), s1238( { s1284, s1284 } ),
s1238( { s1686::s1681, s1284 } ),
s1238( { s1686::s1681, s1284, s1284 } ) }, 1, 3, true ) ) );
...
s1179 = l[2];}
s501* 
s1255::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
wstring s361 = s368();
if( s.find( s361 ) == 0 && ( s.size() == s361.size() || s[s.size() - 1] == L')' ) ) {
...
s512 = s306->TR().s1153( s867::Cont( { s2088, 1, s334, 0 }) );
s867::Cont s1433;
...
s1413();}
void s1255::s364(){
s362.insert( make_pair( L"new", new s351( L"new", &s1255::s1384, s2088,
...
s1039::~s1039(){}
s501* 
s1039::s369( const s269& s736, s278* s612, const wstring& s346 ) const{
wstring s = s736.s297();
wstring s361 = s368();
if( s.find( s361 ) == 0 && ( s.size() == s361.size() || s[s.size() - 1] == L')' ) ) {
wstring sv = s4::s53( s.substr( s361.size() ), s49 );
...
bool s1039::s2158() const{
if( (bool)*eq.s15<s615*>()->s516( 0, 0 ) )
return true;
return false;}
...
return s1835;}
void s1039::s364(){
s362.insert( make_pair( L"new", new s351( L"new", &s1039::s1384, s1587,
...
s673 = s1183[2];}}}
s1266::s1266( s268* s306, s2084& s78, const s269* ast_ )
...
s512 = proto->s366();
s1413();}
s501* s1266::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s736.s297();
wstring s361 = s368();
...
return s717;}
void s1266::s364(){
s362.insert( std::make_pair( L"is-end", new s351( L"is-end", &s1266::s2159, s1274,
{ s1238( {s7::s1565} ) }, 1, 1 ) ) );
...
#define s734 ((s375*)(s502*)*s280)
inline void s1266::s2159( s501** s280, size_t s517 ){
*((s375*)*s280)->s372() = ((s1266*)DR )->s363->s2158();}
...
throw new s16( (uint32_t)s16::s17::s24 );
return *s1409;}}
bool s1055::s2158() const{
if( !s967 )
return s1359 == v->s328().end();
return s1409 == v->s328().rend();}
s277* s1055::Idx(){
*s1314->s372() = s1358 - 1;
return s1314;}
s277* s1055::El(){
...
void s323::s1299( s2084& s78, s278* s612, const s1873& s1937 ){
assert( !s78.empty() );
...
s1170 s323::s1338( s2084& s1427, s867::Cont& s612 ) const{
s1170 s717;
s867::Cont vt;
size_t pos = 0;
s1170 s1431 = 0;
...
return s717;}
void s323::s1297( s2084& s1427, s1170& pt, s1170& vt ) const{
s867::Cont s612;
pt = s1338( s1427, s612 );
vt = s612[2];}
...
s501* s323::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
s363.clear();
s518.clear();}
void s792::s1299( s2084& s78, wstring& s1427, wstring& s673,
...
s1300( s306, s78, s1427, s673 );}
s501* s792::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s736.s297();
wstring sv;
wstring s361 = s368();
...
s1048::s1048( s268* s306, s278* s612, s2084& s78, const s269* ast_, const s1873& s1937 )
: s792( s306, ast_ ){
s1343 = s1284;
if( s78.size() ) {
...
s1343 = right.s1343;
s334 = right.s334;}
s501* s1048::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s = s306->TR().s1429( s736.s297() );
wstring sv;
wstring s361 = s368();
if( s.find( L"[[" ) == 0 )
...
size_t s166 = std::stoi( snum );
s363.resize( s166 );}}}
void s1448::load( s2084& s78, s501* s612, const s1873& s1937 ){
...
s501* s1448::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
: s1539( right.s306, right.ns, ast_ ){
s363 = right.s363;
s512 = right.s512;
s1343 = right.s1343;
s334 = right.s334;
...
s501* 
s332::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
wstring si;
...
s1300( s306, s78, s1427, s673 );}
s501* 
s1552::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
wstring s = s736.s297();
wstring si;
wstring s361 = s368();
if( s[0] == L'{' && s[s.size() - 1] == L'}' )
...
#define DR ((s502*)*(s280 + 1))
#define PARN(n)((s502*)*(s280 + n))
s430::s430( s268* s306, s2084& s78, const s269* ast_ )
: s350( s306, NULL, ast_ ), s797( s306, s1288, NULL ), s860( s306, s1288, NULL ){
s512 = s430::proto.s13() ? 0 : s2086;
s797.s11();
s860.s11();}
...
s860 = right.s860;
s512 = right.s512;}
s501* s430::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
wstring ts = s323::proto->s368() + L"<" + s374::proto->s368() + L">";
s1170 s1691 = s323::proto.s15<s323*>()->s1338( ts, s1433 );
s362.insert( make_pair( L"new", new s351( L"new", &s430::s1384, s2086,
{ s1238() }, 0, 0 ) ) );
...
*s280 = s717;}
void _findFiles( s2084& path, const wregex& rgPatt, vector<wstring>& s40,	vector<wstring>& s41 ){
...
template<class s1591, class s1593>
Stream::s2103 s1577<s1591, s1593>::s2109() const{
return s1649->flags();}
template<class s1591, class s1593>
Stream::s2104 s1577<s1591, s1593>::s2110() const{
return s1649->precision();}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2108(){
if( s1649 )
*s1649 << std::showpos;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2106(){
if( s1649 )
*s1649 << std::noshowpos;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2136(){
if( s1649 )
*s1649 << std::boolalpha;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2137(){
if( s1649 )
*s1649 << std::noboolalpha;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s1743( int n ){
if( s1649 )
*s1649 << std::setw( n );}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2107( int n ){
if( s1649 )
*s1649 << std::setprecision( n );}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2094(){
if( s1649 )
*s1649 << std::left;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2095(){
if( s1649 )
*s1649 << std::right;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2093(){
if( s1649 )
*s1649 << std::internal;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2105(){
if( s1649 )
*s1649 << std::fixed;}
template<class s1591, class s1593>
...
*s1649 << std::showpos;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2134(){
std::ios_base::fmtflags f = (std::ios_base::fmtflags) 0;
if( s1648 )
*s1648 >> std::resetiosflags( f );}
template<class s1591, class s1593>
Stream::s2103 s1577<s1591, s1593>::s2140() const{
return s1648->flags();}
template<class s1591, class s1593>
Stream::s2104 s1577<s1591, s1593>::s2141() const{
return s1648->precision();}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2130(){
if( s1648 )
*s1648 >> std::boolalpha;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2132(){
if( s1648 )
*s1648 >> std::noboolalpha;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2131(){
if( s1648 )
*s1648 >> std::fixed;}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2135( int n ){
if( s1648 )
*s1648 >> std::setw( n );}
template<class s1591, class s1593>
void s1577<s1591, s1593>::s2133( int n ){
if( s1648 )
*s1648 >> std::setprecision( n );}
s527::s527( s268* s306, s278* ns_, const s269* ast_ )
: s1577( s306, ns_, ast_ ){
s512 = s527::proto.s13() ? 0 : s2089;
...
void s527::release(){
ss.clear();}
s501* s527::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s_ = s736.s297();
...
void s527::s1654( s2084& src ){
ss << src;}
void s527::s1636( std::wstring& s156, s2084& s73 ){
if( s73.size() > 1 )
throw new s16( L"multi-char line separators are not supported: '" + s73 + L"'" );
s156.clear();
std::getline( ss, s156, s73[0] );}
void s527::s1655( s2084& src ){
ss << src << endl;}
...
{ s1238() }, 0, 0 ) ) );
s362.insert( make_pair( L"clear", new s351( L"clear", &s1450::s341, s2085,
{ s1238() }, 0, 0 ) ) );
s306->TR().s1301( s512, s7::s1580, s1686::s1679 );
s306->TR().s1301( s512, s7::s1585, s1686::s1683 );
s306->TR().s1301( s512, s7::s1579, s1686::s1678 );}
...
void s1450::release(){
bs.clear();}
s501* s1450::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s_ = s736.s297();
...
void s1450::s1654( s2084& src ){
bs << (tdbyte_t*)U8( src ).c_str();}
void s1450::s1636( std::wstring& s156, s2084& s73 ){
if( s73.size() > 1 )
throw new s16( L"multi-char line separators are not supported: '" + s73 + L"'" );
s156.clear();
s1488 tmp;
std::getline( bs, tmp, (unsigned char)U8(s73.data())[0] );}
void s1450::s1655( s2084& src ){
...
{ s1238() }, 0, 0 ) ) );
s362.insert( make_pair( L"read-bytes", new s351( L"read-bytes", &s1460::s424, s1286,
{ s1238( { s1275 } ), s1238( { s1275, s1284 } ) }, 2, 2 ) ) );
...
fs.close();}
s501*
s1460::s369( const s269& s736, s278* s612, s2084& s346 ) const{
wstring s_ = s736.s297();
...
void s1460::s1654( s2084& src ){
fs << U8(src).data();}
void s1460::s1636( std::wstring& s156, s2084& s73 ){
if( s73.size() > 1 )
throw new s16( L"multi-char line separators are not supported: '" + s73 + L"'" );
if( !fs )
...
s156 = U16( buf.data() );}
void s1460::s1655( s2084& src ){
fs << U8(src).data() << endl;}
void s1460::s1634( s1488& s156, size_t s1646 ){
size_t s1227 = fs.tellg();
size_t fsz = (size_t)fs.seekg( 0, ios::end ).tellg() - s1227;
fs.seekg( s1227 );
size_t s1677 = s1646 ? (std::min)( s1646, fsz ) : fsz;
s156.resize( s1677 );
...
if( !((s1460*)DR)->fs )
throw new s16( L"file stream is not valid" );
s1448& bar = *(s1448*)s280[2];
( (s1460*)DR )->s1634(bar.s328(), 0 );}
...
v.s328().push_back( new s374( ((s1460*)DR)->s306 ) );
v.s328().back().s15<s374*>()->s2139( U16( buf ) );
v.s328().back()->s1413();
if( fs.eof() )
break;}
if( fs.bad() )
...
s1413();}
s501* s1573::s369( const s269& s736, s278* s612, s2084& s346 ) const{
return NULL;}
...
if( s156.size() > s1646 )
s156.resize( s1646 );}
void s1573::s1654( s2084& src ){
throw new s16( L"cannot output to StdIn" );}
void s1573::s1636( std::wstring& s156, s2084& s73 ){
wcin >> std::ws;
s156.clear();
std::getline( wcin, s156 );}
void s1573::s1655( s2084& src ){
throw new s16( L"cannot output to StdIn" );}
...
s1413();}
s501* s1575::s369( const s269& s736, s278* s612, s2084& s346 ) const{
return NULL;}
...
void s1575::s1654( s2084& src ){
wcout << src;}
void s1575::s1636( std::wstring& s156, s2084& s73 ){
throw new s16( L"cannot get input from StdOut" );}
void s1575::s1655( s2084& src ){
wcout << src << endl;}
...
s658.push_back( s386( s77->s643(), s306 ) );}
s608.insert( s608.end(), l.begin() + n, l.end() );}
s501* s905::s369( const s269& s736, s278* s612, const std::wstring& s346 ) const{
...
s1427 = s.substr( 4, s.size() - 5 );
size_t pl = s736.Src().find( 955 );
if( pl != string::npos ) {
s673 = s736.Src().substr( pl );
s = s1427 + L"(" + s673;}
else
s = s1427 + L"()";}
...
return s615::s624( cs, s306, s612, (s905*)this, s612->s304(), false );}
else if( s673[0] != L']' )
...
s615* s905::s1862( const std::wstring& s708, s615* s219, 
s584* cs ) const{
if( s708 == L"new" ) {
if( cs->s626().size() > 1 && (cs->s626()[1]->s513() != s492 ||
((s386*)cs->s626()[1])->s643()[0] != 955 ))
throw new s16( L"malformed lambda syntax" );
s269* s2102 = (s269*)cs->s627();
s905* s2100 = (s905*) s369( *s2102, s612.s15<s278*>(), s612->s304() );
vector<s277*> s2101( { s2100 } );
return new s1857( s306, s612.s15<s278*>(), s219, &s501::s2074, 
s2101, L"new", 0, cs->s627() );}
return s501::s1862( s708, s219, cs );}
...
break;}}}
return s717;}
s2118::s2118( s268* s306, s278* s616, s615* s617, vector<s277*>& l, const s269* s736 )
: s615( s306, s616, s617, s588, s2123, s736, true ){
for( size_t n = 1; n < l.size(); ++n ) {
vector<s277*>& pl = ( (s584*)l[n] )->s626();
pl.insert( begin( pl ), l[n-1] );}
s280.push_back( l.back() );}
void
s2118::s519( const s278* s1848, bool proc ){
s615::s519( s1848, proc );
s512 = s280[0]->s366();}
s504 s2118::s516( s501**, size_t  ){
return s280[0]->s516( 0, 0 );}
...
subject = cs->s626()[0];
s280.assign( cs->s626().begin() + 1, cs->s626().end() );}
void
...
const vector<s277*>& s2101, const wstring& s708, s1170 s1181, 
const s269* s736 )
: s615( s306, s616, s617, s588, s708, s736 ), s1860( ptr_ ){
subject = s2101[0];
s280.assign( s2101.begin() + 1, s2101.end() );
s512 = s1181;}
void
...
wstring s79 = L"in function '" + s284 + L"'";
if( s627() )
s79 += L" :\n" + TDException::s2091( *s627() );
e->s30( s79 );
throw e;}
...
s277* s2118::s349() const{
return new s2118( *this );}
...
vector<wstring> s1045( { L"to:", L":sign", L":nosign", L":boolalpha", 
...
TDException s1059( s7::s2116, s1018, s627(), L"malformed '(textout)' function call" );
s615::s519( s1848, proc );
...
s1059.s1097( L"incorrect usage of formatting marker: " + (s280[n].s15<s386*>())->s643() );
if( mark == s1746 && !s306->TR().s1639(
s280[n + 1]->s366(), s1686::s1723 ) )
s1059.s1097( L"'width:' formatting marker should have an integer parameter" );
if( mark == s2096 && !s306->TR().s1639(
s280[n + 1]->s366(), s1686::s1723 ) )
s1059.s1097( L"'fill:' formatting marker should have a char (one symbol string) parameter" );}}
s1413();}
s504 s634::s516( s501** s723, size_t s732 ){
s501* s717 = s1787( s723, s732 );
if( s717 )
return s717;
s1::s9<Stream> s826;
if( s42.s14() ) {
...
vector<wstring> s2120( { L"from:", L":boolalpha", L":noboolalpha", L"width:", 
L"prec:", L":fixed", L":group", L":nl" } );
s2119::s2119( s268* s306, s278* s616, s615* s617, 
const vector<s277*>& l, const s269* s736 )
: s615( s306, s616, s617, s588, s2124, s736 ), source( NULL ),
lin( false ){
if( l.empty() )
throw new s16( L"Wrong numbers of arguments" );
size_t pl1 = s736->Src().find( L"lin" );
if( pl1 < s736->Src().find( L"textin" ) )
lin = true;
vector<s277*>tmp( l );
s615::s1392( tmp, s2120 );
s280.assign( tmp.begin(), tmp.end() );
s512 = s779->s366();}
s2119::s2119( s268* s306 )
: s615( s306, NULL, NULL, s588, s2124, NULL ), source( NULL ),
lin( false ){
s512 = s779->s366();}
void s2119::s519( const s278* s1848, bool proc ){
TDException s1059( s7::s2115, s1018, s627(), L"malformed '(textin)' function call" );
s615::s519( s1848, proc );
if( (s280[0]->s513() == s1172 && s280[0].s15<s386*>()->Id() == s1372 ) ||
(s306->TR().s1639( s280[0]->s366(), s1686::s1679 ))) {
int s390 = 1;
if( s280[0]->s513() == s1172 )
s390 = 2;
source = s280[s390 - 1];
s280.erase( s280.begin(), s280.begin() + s390 );
s607.erase( s607.begin()+1, s607.begin() + s390 + 1 );
nlocs = s280.size();
s517 = s607.size();}
for( size_t n = 0; n < s280.size(); ++n ) {
if( s280[n]->s513() == s1172 ) {
...
s1059.s1097( L"'width:' formatting marker should have an integer parameter" );}}
s1413();}
s504 s2119::s516( s501** s723, size_t s732 ){
size_t shift = 1;
for( size_t n = 0; n < nlocs; ++n ) {
if( *( s604 + n ) ) {
s489 pc = ( ( s502* )*( s604 + n ) )->s513();
...
s489 pc = source->s513();
if( pc == s493 )
src = source->s516( 0, 0 ).s15<Stream*>();
else if( pc == s492 )
src = (Stream*)source.s15<s386*>()->s392();
else
src = source.s15<Stream*>();}
else
src = s1574.s15<Stream*>();
src->s1741();
for( size_t n = 1; n < s607.size(); ++n ) {
if( s607[n]->s513() == s1172 ) {
int mark = (int)*( (s386*)s607[n] )->s392();
...
src->ws();
return s380;}
s277* s2119::s349()const{
return new s2119( *this );}
...
return rechash;}
s504 s824::s804( s2084& s77, bool s749 ) const{
...
s512 = right.s512;}
s501* s679::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
wcout << it->first;}}
void s679::select( s2084& field, s1957::s1970 op, const s501* s1174,
s1966& s156 ){
...
s1979::~s1979(){
s2040.clear();}
s504 s1979::s804( s2084& s77, bool s749 ) const{
...
s1980::s1980( s268* s306, s278* s612, s2084& s78, const s269* ast_ )
: s1960( s306, s612, ast_ ){
s518 = s78;
...
release();}
s501* 
s1980::s369( const s269& s736, s278* s612, s2084& s346 ) const{
...
void s1980::s753( s2084& s880, const s1898& tbfr ){
wstring s783 = tbfr.s1912;
vector<wstring> s870;
vector<wstring> s881;
size_t pl = -1;
...
size_t s1980::s2012( s2084& s1995 ) const{
...
if( s1541.empty() ) {
s1542 = { L"", 
s1601, s248, s1602, s263, s1790, 
s261, s986, s265, s235, s817,
s877, s257, s1791, s249,s2123,
s1792, 
s923,s267, s1794, s1795, s803, 
s2065, s1793, s2124, s2122, s256, 
s1736,s264, s262, s873, s1796, 
s1483, s260, s238 };
...
s717 = new s2118( this, s612, s219, s740, s736 );
else if( s1631 == s1623 )
s717 = new s311( this, s612, s219, s740, s736 );
else if( s1631 == s1614 )
s717 = new s631( this, s612, s219, s740, s736 );
else if( s1631 == s2127 || s1631 == s2125)
s717 = new s2119( this, s612, s219, s740, s736 );
