...
s559* cs ) const{
if( s672 == L"cp" ) {
return new s1667( s300, s1658, s215, &s481::s1689, cs->s600(),
...
s1054 s1084 = s1003( stype ); // ???DEBUG??? 220929
...
s886[s7::s2300] = 1;
s1249[1] = s7::s2300;
s1088[s7::s2300] = s2306++;
s2303.push_back( s7::s2300 );
s1196 = 1;
s1264.push_back( 0 );
...
s1540.push_back( vector<s1054>() );
s1104.push_back( s1104[vt.s350( 0 )] );
size_t s2297 = s1104.size();
s1104[s2297-1] = s1104[s1084]->s353( s300, v );
return s1084;}
...
if( !s617->s499( (s481*)is ) ) {
s1054 pt = is->s350();
if( is->s350() == Types.No )
pt = (s1054)( (s382*)is )->s1529();
auto it = s2309.find( pt );
if( it != s2309.end() ) {
if( it->second->s492() == s475 ) {
s483 tmp = s271::s1011( s300, s300, s300, NULL, L"::", false );
s2309[pt] = tmp.s15<s832*>();
it = s2309.find( pt );}
if( !it->second->s1195() )
it->second->s498( s300, false );
vector<s483> s274 = { (s271*)s617 };
it->second->s594( s274 );
if( (bool)*it->second->s495( 0, 0 ) )
return true;}
return false;}}
return true;}
...
void s489::s2304( s1890& def, s832* pred, s1890& s1826 ){
if( s1088.find( def ) != end( s1088 ) )
throw new s16( L"type definition already exists" );
s1054 typid;
typid = s2306++; //(s1054)s1087.size();
s2309[typid] = pred;
s1088[def] = typid;
s2303.push_back( def );
auto it1 = s1827.find( s1826 );
...
else if( s347.find( L"typedef" ) == 0 ) {
size_t pl = s347.find( L"(" );
wstring s345 = s4::s52( s347.substr( pl + 1, s347.size() - pl - 2 ), s4::s48 );
s940 ast1 = new s263( s345, NULL, NULL );
size_t pos = 0;
ast1->s269( s2299, s141( NULL, L"true,", pos, s1722 ) );
s2304( s695.s299(), 
(s832*)s1104[s1088.find( L"Lambda" )->second]->s352( *ast1, s586, s517 ),
s517 );
return s1104[s1088[Types( s300, Types.String )->s351()]]->s352( s695, s586, s517 );}
wstring s345 = L"";
s481* s681 = NULL;
...
auto it2 = s2309.find( it->second );
if( it2 != s2309.end() ) {
return new s382( s300, s586, it->second, s2307 );}
throw new s16( L"Type does not exist: " + s347, (uint32_t)s16::s17::s23 );}
...
if( n >= s1087.size() && n > s2298 && (n - s2298) > s2303.size() )
throw new s16( L"no type with such ordinal: " + std::to_wstring( n ) );
if( n < s2298 )
return s1087[n];
return s2303[n - s2298];}
...
return NULL;}
s1890& s382::s351() const{
if( s490 == s2307 )
return s300->TR().s798( s1262 );
return s334::s351();}
...
if( s490 == s2307 )
return s300->TR().s1523( s500, this );
...
{ s1113() }, 0, 0 ) ) );
s346.insert( make_pair( L"randr", new s335( L"randr", &s344::s2308, s1142, //0
{ s1113( { s1501::s1261 } ), s1113() }, 0, 1 ) ) );
s300->TR().s1522( s491, Types.Long );}
s1054 s344::s1179( s1890& s1541, const vector<s483>& l ) const{
s1054 s681 = 0;
if( s1541 == L"randr" )
s681 = s1142;
else
s681 = s1296::s1179( s1541, l );
return s681;}
...
inline void s344::s2308( s481** s274, size_t s496 ){
int mn, mx;
if( s496 == 2 ) {
mn = 0;
mx = (int)*s274[1];}
...
adds->s347 = s.substr( s1805, sm.position( 0 ) );
if( adds->s347.size() )
pv->s318().push_back( (s481*)adds->s333( 0,0 ) );
s1805 = s1805 + sm.position( 0 ) + sm.length( 0 );
itst = s.begin() + s1805;}}
else {
while( s69 != wstring::npos && s68 < s.size()) {
if( s72.size() )
...
Iterator* s357::s1180() {
return new s1566( s300, this, s347.end(), s347.end() ); }
Iterator* s357::s312( s383* rv, bool s2296 ){
if( !rv ) {
if( !s2296 )
return new s1566( s300, this, begin( s347 ), end( s347 ) );
else
return new s1566( s300, this, rbegin( s347 ), rend( s347 ) );}
...
return s981 == s1535;}
Iterator* s383::s312( s383* r, bool s2296 ){
if( s1233.s14() ) {
s470 pc = s1233->s492();
if( pc == s474 )
...
Iterator* s1125::s312( s383* r, bool s2296 ){
if( range.s14() ) {
s1135 pr = range->s1185( );
s316 = pr.first;
s1478 = pr.second;}
else {
s316 = s978.s15<s324*>()->s312( NULL, s2296 );
s1478 = NULL;}
return this;}
...
return true;
return false;}
Iterator* s944::s312( s383* r, bool s2296 ){
assert( !s2296 );
set->s495( 0, 0 );
s1040 = true;
return this;}
...
s932::s932( s262* s300, s322* v_, s1237 it, s1237 sent )
: v( v_ ), s1248( it ), s1477( sent ), s1164( s363 ), s1163( new s952( s300, NULL,
vector<s271*>(	{ 
s300->TR().s516( v_->s931(), s300, v_->s2154() ),
s300->TR().s516( v_->ValType(), s300, v_->s2154() )
} ) ) ){
...
if( s1248 != v->s318().rend() ) {
s1163->assign( vector<s483>(
{ ( *s1248 ).first.s15<s271*>(),( *s1248 ).second.s15<s271*>() } ));
s681 = s1163; }}
return s681;}
void s932::reverse(){
s878 = true;
s1248 = std::make_reverse_iterator( s1205 );
s1477 = std::make_reverse_iterator( s1079 );}
...
bool s314::operator<( const s481* p ) const{
return false;}
Iterator* s314::s312( s383* rv, bool s2296 ){
if( !rv ) {
if( !s2296 )
return new s957( s300, this, begin( s347 ), end( s347 ) );
else
return new s957( s300, this, rbegin( s347 ), rend( s347 ) );}
s1135 pr = rv->s1185( this );
...
bool s744::operator<( const s481* p ) const{
return false;}
Iterator* s744::s312( s383* rv, bool s2296 ){
return NULL;}
/*s484 s744::s313()
{
if( s316 == s347.end() ) {
...
bool s1282::operator<( const s481* p ) const{
return false;}
Iterator* s1282::s312( s383* rv, bool s2296 ){
s1135 pr = rv->s1185( this );
...
{ s1113( { s7::s1385, s7::s1386 } ) }, 2, 2 ) ) );
s346.insert( make_pair( L"keys", new s335( L"keys", &s322::s2295, 0,
{ s1113() }, 0, 0 ) ) );
...
s346.equal_range( L"get" ).first->second->s1251( true );
s346.equal_range( L"get-val" ).first->second->s1251( true );
s346.equal_range( L"keys" ).first->second->s1251( true );
...
inline void s322::s2295( s481** s274, size_t s496 ){
s322* p = (s322*)DR;
...
Iterator* s322::s312( s383* rv, bool s2296 ){
if( !rv ) {
if( !s2296 )
return new s932( s300, this, begin( s347 ), end( s347 ) );
else
return new s932( s300, this, rbegin( s347 ), rend( s347 ) );}
s1135 pr = rv->s1185( this );
...
Iterator* s1371::s312( s383* rv, bool s2296 ){
assert( !s2296 );
if( !rv )
...
Iterator* s2204::s312( s383* rv, bool s2296 ){
if( !rv ) {
if( !s2296 )
return new s2205( s300, this, begin( s347 ), end( s347 ) );
else
return new s2205( s300, this, rbegin( s347 ), rend( s347 ) );}
s1135 pr = rv->s1185( this );
...
throw new s16( L"method is not implemented" );}
Iterator* s2237::s312( s383* rv, bool s2296 ){
assert( !s2296 );
if( !rv )
...
s309( s7::s460, s300 ), s310( s300, 0, NULL ), s2274( NULL ), s878( false ){
...
p = l[3];
size_t idx = 4; 
wstring s988 = L"malformed 'for' statement";
if( p->s492() != s473 )
throw s961.s993( s988 );
if( ((s369*)p)->s615() == L":rev" ) {
s878 = true;
p = l[idx++];}
...
p = l[idx++];}
if( p->s492() != s473 )
throw new s16( s988 + L": the DO clause is missing" );
...
vt = ( (s324*)s1465 )->s317();
if( s878 && !s300->TR().s1454( s1465->s350(), s1501::s1495 ) )
throw s961.s993( L"iterable doesn't support the reverse iteration" );
...
const s141& nv = s695.s268( s2299 );
bool s2302 = false;
if( !( nv == s265 ) )
s2302 = nv.s722();
return new s832( s300, s586, NULL, cs->s600(), &s695, pt, s2302 );}
else if( s642[0] != L']' )
