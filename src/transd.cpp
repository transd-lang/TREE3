...
: s589( right, NULL, s591, ns_, vector<s482*>(), s601(),
false, right.s2159 ), 
...
s581[0] = s584;}
s835::~s835(){}
s836::s836( s262* s300, s272* s586, s589* s585, s272* ns_, s561 ct,
const std::vector<s271*>& l, const s263* s695, bool s2160 )
: s589( s300, s586, s585, ns_, ct, l, s695, false, s2160 ){
if( ct == s566 ) {
subject = s586;		}}
...
s347[n] = s1081->s495( 0, 0 ).s15<s271*>();
if( !s323 )
s323 = s347[0]->s350();
else if( s323 != s347[n]->s350() )
...
for( size_t n = 0; n < s347.size(); ++n ) {
if( 1 && s347[n]->s492() == s473 ) {// ???DEBUG??? 220713
s347[n]->s498( s873 );
s347[n] = s347[n].s15<s369*>()->s375();}
s483 s1081;
if( !s347[n]->s1195() ) {
...
s481* s152 = (s481*)PARN( 2 )->s333(0,0);
s481* s347 = (s481*)PARN( 3 )->s333(0,0);
s322* dr = (s322*)DR;
